<div className="flex bg-gray-100 dark:bg-slate-950 min-h-screen">
        <aside className="hidden sm:flex sm:flex-col">
          ...
          <div className="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
            <nav className="flex flex-col mx-4 my-6 space-y-4">
              ...
              <a href="#" className="inline-flex items-center justify-center py-3 text-blue-600 bg-white dark:bg-slate-900 rounded-lg">
        ...
        <div className="flex-grow text-gray-800 dark:text-gray-200 mt-16">
          <header className="flex items-center h-20 px-6 sm:px-10 bg-white dark:bg-slate-900">
            <button className="block sm:hidden relative flex-shrink-0 p-2 mr-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 hover:text-gray-800 focus:bg-gray-100 focus:text-gray-800 rounded-full">
            ...
            <div className="relative w-full max-w-md sm:-ml-2">
              ...
              <input type="text" role="search" placeholder="Search..." className="py-2 dark:bg-slate-900  ring-1 pl-10 pr-4 w-full border-4 border-transparent placeholder-gray-400 focus:bg-gray-50 rounded" />
            </div>
            ...
            <div className="flex flex-shrink-0 items-center ml-auto">
              <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
                ...
                <div className="hidden md:flex md:flex-col md:items-end md:leading-tight">
                  <span className="font-semibold">Godwin Mangai</span>
                  <span className="text-sm text-gray-600">Admin</span>
                </div>
                <span className="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
                  <img src="https://randomuser.me/api/portraits/men/76.jpg" alt="user profile" className="h-full w-full object-cover" />
                </span>
          ...
          <main className="p-6 sm:p-10 space-y-6">
            <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
              <div className="mr-6">
                ...
                <h2 className="text-gray-600 dark:text-slate-400 ml-0.5">My Language Tutor Site</h2>
              </div>
              <div className="flex flex-wrap items-start justify-end -mb-3">
                ...
                <button className="inline-flex px-5 py-3 text-white bg-blue-600 hover:bg-blue-700 focus:bg-blue-700 rounded ml-6 mb-3">
            ...
            <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              ...
              <div className="flex items-center p-8 bg-white dark:bg-slate-900 shadow rounded-lg">
            ...
            <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
              ...
              <div className="flex flex-col md:col-span-2 md:row-span-2 bg-white dark:bg-slate-900 shadow rounded-lg">
                <div className="px-6 py-5 font-semibold border-b border-gray-100">The number of new students registering</div>
                <div className="p-4 flex-grow">
                  <div className="flex items-center justify-center h-full px-4 py-16 text-gray-400 text-3xl font-semibold bg-gray-100 dark:bg-slate-950 border-2 border-gray-200 border-dashed rounded-md">Chart</div>
                </div>
              </div>
              ...
              <div className="row-span-3 bg-white dark:bg-slate-900 shadow rounded-lg">
                <div className="flex items-center justify-between px-6 py-5 font-semibold border-b border-gray-100">
                  <span>Students by average mark</span>
                  <button type="button" className="inline-flex justify-center rounded-md px-1 -mr-1 bg-white dark:bg-slate-900 text-sm leading-5 font-medium text-gray-500 hover:text-gray-600" id="options-menu" aria-haspopup="true" aria-expanded="true">
                    Descending
              ...
              <div className="flex flex-col row-span-3 bg-white dark:bg-slate-900 shadow rounded-lg">
                <div className="px-6 py-5 font-semibold border-b border-gray-100">Students by type of studying</div>
                <div className="p-4 flex-grow">
                  <div className="flex items-center justify-center h-full px-4 py-24 text-gray-400 text-3xl font-semibold bg-gray-100 dark:bg-slate-950 border-2 border-gray-200 border-dashed rounded-md">Chart</div>
                </div>
              </div>
