...
import { FaEdit, FaLanguage, FaBell, FaLock, FaUser, FaSignOutAlt } from 'react-icons/fa';
...
const SettingsPage = () => {
  ...
  return (
    <Layout>
        <section className="pt-20 py-10 text-slate-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <p className="text-sm text-gray-600 mb-4">Manage your account details.</p>
            ...
            <p className="text-sm text-gray-600 mb-4">Set your learning languages.</p>
            <ul className="space-y-3">
                <li>
