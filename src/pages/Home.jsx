...
const Home = () => {
  return (
    <div className=" px-4 mt-16 ">
      ...
      {/* why section */}
      <div className="relative bg-white dark:bg-slate-950 py-16 px-6 md:px-12 lg:px-20 mb-16 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-2xl dark:text-slate-300 font-semibold text-gray-800 mb-2">
              Advanced AI Tools
            </h3>
      ...
      {/* Banner Section */}
      <div className="bg-blue-600 text-white text-center py-10 mb-16 relative">
        <div
        ...
        ></div>
        <h2 className="text-4xl dark:text-slate-200 font-bold relative z-[5] px-5">Ready to <span className="relative whitespace-nowrap text-white">
        ...
        <p className="text-lg dark:text-slate-200 mt-4 relative z-[5]">
          Take the first step in your language-learning journey with state-of-the-art AI tools.
        </p>
        <button className="mt-6 bg-white dark:bg-slate-950 text-blue-600 dark:text-slate-200 font-semibold py-2 px-6 rounded-full hover:bg-gray-100 dark:hover:bg-slate-900 relative z-[5]">
          Explore Features
        </button>
      </div>
          ...
          {/* Image Section */}
      <div className="flex flex-col md:flex-row items-center bg-gradient-to-br from-blue-50 to-white dark:from-blue-900 dark:to-blue-950 p-2 pt-5 md:py-16 sm:px-6 md:px-12 lg:px-20 rounded-lg shadow-md my-16">
        {/* Image Section */}
        ...
        <div className="w-full md:w-1/2 md:pl-12">
          <h2 className="text-4xl dark:text-slate-200 font-bold text-gray-800 mb-4">
            Learn Smarter, Not Harder
          </h2>
          <p className="text-lg dark:text-slate-200 text-gray-600 dark:text-slate-400 mb-6">
      ...
      <div className=" text-slate-950 py-10 px-3 md:px-12 lg:px-20 rounded-lg mb-16">
        <h1 className=" text-4xl dark:text-slate-200 font-bold text-center mb-6 leading-tight">
          Break <span className="relative whitespace-nowrap text-blue-600">
                  <svg aria-hidden="true" viewBox="0 0 418 42" className="absolute top-2/3 left-0 h-[0.58em] w-full fill-blue-300/70" preserveAspectRatio="none"><path d="M203.371.916c-26.013-2.078-76.686 1.963-124.73 9.946L67.3 12.749C35.421 18.062 18.2 21.766 6.004 25.934 1.244 27.561.828 27.778.874 28.61c.07 1.214.828 1.121 9.595-1.176 9.072-2.377 17.15-3.92 39.246-7.496C123.565 7.986 157.869 4.492 195.942 5.046c7.461.108 19.25 1.696 19.17 2.582-.107 1.183-7.874 4.31-25.75 10.366-21.992 7.45-35.43 12.534-36.701 13.884-2.173 2.308-.202 4.407 4.442 4.734 2.654.187 3.263.157 15.593-.78 35.401-2.686 57.944-3.488 88.365-3.143 46.327.526 75.721 2.23 130.788 7.584 19.787 1.924 20.814 1.98 24.557 1.332l.066-.011c1.201-.203 1.53-1.825.399-2.335-2.911-1.31-4.893-1.604-22.048-3.261-57.509-5.556-87.871-7.36-132.059-7.842-23.239-.254-33.617-.116-50.627.674-11.629.54-42.371 2.494-46.696 2.967-2.359.259 8.133-3.625 26.504-9.81 23.239-7.825 27.934-10.149 28.304-14.005.417-4.348-3.529-6-16.878-7.066Z"></path></svg>
                  <span className="relative">Barriers,</span></span> Speak Fluently
        </h1>
        <p className="text-lg dark:text-slate-200 dark:text-slate-400 md:text-xl text-center max-w-4xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-white dark:from-blue-900 dark:to-blue-950 py-10 px-3 sm:px-3 md:px-12 lg:px-20 rounded-lg mb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          {/* Checkbox Section */}
          <div className="bg-white dark:bg-slate-950 p-3 md:p-6 rounded-lg shadow-md">
            <h3 className="text-2xl dark:text-slate-300 font-semibold text-gray-800 mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16 via-white to-gray-50 p-3 md:p-8 rounded-xl">
        ...
        <div className="text-center p-6 dark:bg-slate-900 bg-gradient-to-r from-blue-50 via-white to-blue-100 dark:from-blue-950 dark:via-blue-900 dark:to-blue-950 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="text-center p-6 dark:bg-slate-900 bg-gradient-to-r from-green-50 via-white to-green-100 dark:from-blue-950 dark:via-blue-900 dark:to-blue-950 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="text-center p-6 bg-gradient-to-r from-blue-50 via-white to-blue-100 dark:from-blue-950 dark:via-blue-900 dark:to-blue-950 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
          <div className="w-16 h-16 mx-auto mb-4 flex items-center justify-center rounded-full bg-blue-200">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-white dark:from-blue-900 dark:to-blue-950 py-12 px-2 sm:px-6 md:px-12 lg:px-20 rounded-lg shadow-lg mb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          {/* Text Section */}
          <div>
            <h2 className="text-4xl dark:text-slate-100 font-bold text-gray-800 leading-snug mb-4">
            ...
            <p className="text-lg dark:text-slate-200 text-gray-600 dark:text-slate-300 mb-6">
            ...
            <ul className="space-y-4">
              <li className="flex items-center dark:text-slate-300">
                <span className="inline-block w-4 h-4 bg-blue-500 rounded-full mr-3"></span>
          ...
          <div className="bg-white dark:bg-slate-950 p-5 sm:p-8 rounded-lg shadow-lg">
            <h3 className="text-2xl dark:text-slate-200 font-semibold text-gray-800 mb-6">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h4 className="text-lg dark:text-slate-200 font-semibold text-gray-800">Personalization</h4>
                  <p className="text-gray-600 dark:text-slate-400">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h4 className="text-lg dark:text-slate-200 font-semibold text-gray-800">Emotion</h4>
                  <p className="text-gray-600 dark:text-slate-400">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h4 className="text-lg dark:text-slate-200 font-semibold text-gray-800">Creativity</h4>
                  <p className="text-gray-600 dark:text-slate-400">
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-slate-950 rounded-lg dark:ring-1 dark:p-2 shadow-md overflow-hidden">
            <img
              src={Grammer}
              alt="Resource 1"
            ...
            />
            <div className="p-6">
              <h3 className="text-xl font-semibold dark:text-slate-200 text-gray-800">
