                    ...
                    <div className=" mt-0 sm:mt-8 flex flex-col items-center">
                        ...
                        <div className="w-full flex-1 mt-6">
                            ...
                            <form className="mx-auto max-w-xs">
                                <input className="w-full px-8 py-4 rounded font-medium bg-gray-100 dark:border-slate-700 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white dark:bg-slate-950" type="email" placeholder="Email" />
                                <input className="w-full px-8 py-4 rounded font-medium bg-gray-100 dark:border-slate-700 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white dark:bg-slate-950 mt-5" type="password" placeholder="Password" />
