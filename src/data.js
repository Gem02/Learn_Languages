      ...
      [
        {
          "id": "english",
          "name": "English",
          "content": "Greetings are an essential part of communication in English. They help you start conversations and establish a friendly tone. Here are some examples of formal and informal greetings.",
          "examples": [
            {
              "exampleName": "Formal Greetings",
              "exampleList": [
                "Good morning",
                "Good afternoon",
                "Good evening",
            ...
            {
              "exampleName": "Informal Greetings",
              "exampleList": [
                "Hi",
                "What's up?",
                "How's it going?",
            ...
            {
              "exampleName": "Examples of Use",
              "exampleList": [
                "When meeting someone for the first time: Nice to meet you.",
                "When parting ways: Goodbye or Take care.",
                "When starting a formal email: Dear [Recipient's Name],",
                "When ending a formal email: Best regards, [Your Name]."
              ]
            },
            {
              "exampleName": "Introducing Yourself",
              "exampleList": [
            ...
            {
              "exampleName": "Asking About Someone's Day",
              "exampleList": [
                "How was your day?",
                "How was your week?",
          ...
          "keyVocabulary": [
            ...
            {"phrase": "Hi", "usage": "Informal greeting"},
            {"phrase": "Good morning", "usage": "Morning greeting"},
            {"phrase": "Good afternoon", "usage": "Afternoon greeting"},
            {"phrase": "Good evening", "usage": "Evening greeting"},
            {"phrase": "What's up?", "usage": "Informal greeting to ask about someone's well-being"}
          ],
          "media": [
            "https://example.com/audio-basic-greetings-en.mp3",
            "https://example.com/image-basic-greetings-en.png"
          ]
        },
        {
          "id": "hausa",
          "name": "Hausa",
          "content": "Sannu a wajan yin magana a Hausa. Suna taimaka wajen fara tattaunawa da kuma kawo yanayi na abota. Here are some examples of formal and informal greetings in Hausa.",
          "examples": [
            {
              "exampleName": "Formal Greetings (Sannu na Hukuma)",
              "exampleList": [
                "Ina kwana? (How did you sleep?)",
                "Lahiya lau (reply - in health)",
                "Barka da safe (Good morning)",
                "Barka da rana (Good day)",
                "Barka da yamma (Good afternoon/evening)",
                "Allah ya ba mu alheri Mu kwana lafiya (Good night)",
                "Sannu da zuwa (Welcome)",
                "Ina iyali? (How is your family?)",
                "Ina gajiya? (How is your tiredness?)"
              ]
            },
            {
              "exampleName": "Informal Greetings (Sannu na Yau da Kullun)",
              "exampleList": [
                "Sannu",
                "Ku dai? (What's up?)",
                "Yaya ku? (How's it going?)",
                "Hey (Hey)",
                "Sai an jima (See you later)",
                "Sai gobe (See you tomorrow)",
                "Na farin cikin haduwa da kai (Pleased to meet you)"
              ]
            },
            {
              "exampleName": "Examples of Use",
              "exampleList": [
                "When meeting someone for the first time: Na farin cikin haduwa da kai.",
                "When parting ways: Sai an jima or Allah ya kiyaye.",
                "When starting a conversation: Ina kwana?",
                "When responding to a greeting: Lahiya lau."
              ]
            },
            {
              "exampleName": "Introducing Yourself",
              "exampleList": [
                ...
                "Na aiki a matsayin [Your Profession].",
                "Na karatu [Your Field of Study]."
              ]
            },
            {
              "exampleName": "Asking About Someone's Day",
              "exampleList": [
                ...
                "Ina yara? (How are your children?)",
                "Ina marece? (How is the afternoon?)"
              ]
            }
          ],
          "keyVocabulary": [
            {"phrase": "Sannu", "usage": "General greeting"},
            {"phrase": "Ina kwana?", "usage": "Morning greeting"},
            {"phrase": "Barka da yamma", "usage": "Afternoon/evening greeting"},
            {"phrase": "Ku dai?", "usage": "Informal greeting to ask about someone's well-being"}
          ],
          "media": [
            "https://example.com/audio-basic-greetings-ha.mp3",
            "https://example.com/image-basic-greetings-ha.png"
          ]
        },
        {
          "id": "french",
          "name": "French",
          "content": "Les salutations sont une partie essentielle de la communication en français. Elles vous aident à engager une conversation et à établir un ton amical. Here are some examples of formal and informal greetings in French.",
          "examples": [
            {
              "exampleName": "Formal Greetings (Salutations formelles)",
              "exampleList": [
                "Bonjour (Good day)",
                "Bonne journée (Good day)",
                "Bonne soirée (Good evening)",
                "Bonjour, monsieur/madame/docteur [Nom de famille] (Hello, Mr./Ms./Mrs./Dr. [Last Name])",
                ...
                "Cher Professeur/Docteur [Nom de famille]"
              ]
            },
            {
              "exampleName": "Informal Greetings (Salutations informelles)",
              "exampleList": [
                "Salut",
                "Ça va? (What's up?)",
            ...
            },
            {
              "exampleName": "Examples of Use",
              "exampleList": [
                "When meeting someone for the first time: Enchanté/e de faire votre connaissance.",
                "When parting ways: À bientôt or Au revoir.",
                "When starting a conversation: Bonjour, comment allez-vous?",
                "When responding to a greeting: Ça va bien, merci."
              ]
            },
            {
              "exampleName": "Introducing Yourself",
              "exampleList": [
                ...
                "Je travaille comme [Your Profession].",
                "J'étudie [Your Field of Study]."
              ]
            },
            {
              "exampleName": "Asking About Someone's Day",
              "exampleList": [
                "Quelle a été votre journée? (How was your day?)",
                "Comment s'est passée votre semaine? (How was your week?)",
                "Comment s'est passée votre fin de semaine? (How was your weekend?)"
              ]
            }
          ],
          "keyVocabulary": [
            {"phrase": "Bonjour", "usage": "General greeting"},
            {"phrase": "Salut", "usage": "Informal greeting"},
            {"phrase": "Bonne journée", "usage": "Day greeting"},
            {"phrase": "Bonne soirée", "usage": "Evening greeting"},
            {"phrase": "Ça va?", "usage": "Informal greeting to ask about someone's well-being"}
          ],
          "media": [
            "https://example.com/audio-basic-greetings-fr.mp3",
            "https://example.com/image-basic-greetings-fr.png"
          ]
        },
        {
          "id": "spanish",
          "name": "Spanish",
          "content": "Los saludos son una parte esencial de la comunicación en español. Ayudan a iniciar conversaciones y establecer un tono amistoso. Here are some examples of formal and informal greetings in Spanish.",
          "examples": [
            {
              "exampleName": "Formal Greetings (Saludos formales)",
              "exampleList": [
                "Buenos días (Good morning)",
                "Buenas tardes (Good afternoon)",
                "Buenas noches (Good evening)",
                "Hola, señor/señora/docteur [Apellido] (Hello, Mr./Ms./Mrs./Dr. [Last Name])",
                ...
                "Estimado/a Profesor/Doctor [Apellido]"
              ]
            },
            {
              "exampleName": "Informal Greetings (Saludos informales)",
              "exampleList": [
                "Hola",
                "¿Qué tal? (What's up?)",
            ...
            },
            {
              "exampleName": "Examples of Use",
              "exampleList": [
                "When meeting someone for the first time: Mucho gusto.",
                "When parting ways: Hasta luego or Adiós.",
                "When starting a conversation: Hola, ¿cómo estás?",
                "When responding to a greeting: Estoy bien, gracias."
              ]
            },
            {
              "exampleName": "Introducing Yourself",
            ...
            },
            {
              ...
              "exampleList": [
                ...
                "¿Cómo ha sido tu semana? (How was your week?)",
                "¿Cómo ha sido tu fin de semana? (How was your weekend?)"
              ]
            }
          ],
          "keyVocabulary": [
            {"phrase": "Hola", "usage": "General greeting"},
            {"phrase": "Buenos días", "usage": "Morning greeting"},
            {"phrase": "Buenas tardes", "usage": "Afternoon greeting"},
            {"phrase": "Buenas noches", "usage": "Evening greeting"},
            {"phrase": "¿Qué tal?", "usage": "Informal greeting to ask about someone's well-being"}
          ],
          "media": [
            "https://example.com/audio-basic-greetings-es.mp3",
            "https://example.com/image-basic-greetings-es.png"
          ]
        },
      ],
    },
      ...
      [
        {
          "id": "english",
          "name": "English",
          "content": "Expressing love is a universal language, but it can be beautifully nuanced in different cultures. Here are some common ways to express love in English.",
          "examples": [
            {
              "exampleName": "Declaring Love",
              "exampleList": [
                {
                  "phrase": "I love you",
                  "meaning": "A direct expression of love"
                },
                {
                ...
                {
                  "phrase": "My heart belongs to you",
                  "meaning": "My affection is exclusively for you"
                }
              ]
            },
            {
              "exampleName": "Romantic Expressions",
              "exampleList": [
                {
                  "phrase": "You are my everything",
                  "meaning": "You are the most important part of my life"
                },
                {
                  "phrase": "I am so happy when I am with you",
                  "meaning": "Being with you makes me very happy"
                }
              ]
            },
            {
              "exampleName": "Love Idioms",
              "exampleList": [
                {
                ...
                },
                {
                  ...
                  "meaning": "Completely and utterly in love"
                }
              ]
            }
          ],
          "keyVocabulary": [
            {"phrase": "I love you", "usage": "A direct expression of love"},
            {"phrase": "You mean the world to me", "usage": "To emphasize someone's importance"},
            {"phrase": "My heart belongs to you", "usage": "To express exclusive affection"}
          ],
          "media": [
            "https://example.com/audio-love-expressions-en.mp3",
            "https://example.com/image-love-expressions-en.png"
          ]
        },
        {
          "id": "hausa",
          "name": "Hausa",
          "content": "Bayyana soyayya a cikin yare Hausa yana da ban mamaki da tsauri. Ga wasu misalan yadda ake bayyana soyayya a Hausa, tare da fassarar Turanci.",
          "examples": [
            {
              "exampleName": "Sanar da Soyayya",
              "exampleList": [
                {
                  "phrase": "Na so ka",
                ...
                {
                  "phrase": "Zuciya ta zama takarda, tawa ta zama biro in rubata miki shafin kauna",
                  "translation": "My heart has become paper, the pen has become my pen to write your love story"
                }
              ]
            },
            {
              "exampleName": "Maganganu Mai Alaka da Soyayya",
              "exampleList": [
                {
                  "phrase": "Kizama kofa na zamao makulli, mu hadu mu bude kofar soyyar lambun zuciyata",
                  "translation": "My heart is locked and has become calm, let us meet and open the door of our love"
                },
                {
                  "phrase": "Ya madarar zuciyata, ki zamo ciminti in zamo bulo mu gina gidan quana a filin soyayya",
                  "translation": "Oh, the pain of my heart, you be my foundation and my mud to build our house of love"
                }
              ]
            },
            {
              "exampleName": "Tirkashin Soyayya",
              "exampleList": [
                {
                  "phrase": "Gaisuwa daga kamfanin so, harabar kauna, gida mai lambar zuciyata layin begen ki, zuwa ga rabin rayuwata",
                  "translation": "Greetings from the company of love, the house of love, the home with the symbol of my heart, towards the half of my life"
                }
              ]
            }
          ],
          "keyVocabulary": [
            {"phrase": "Na so ka", "usage": "A direct expression of love", "translation": "I love you"},
            {"phrase": "Zuciya ta zama takarda", "usage": "To express the depth of one's feelings", "translation": "My heart has become paper"}
          ],
          "media": [
            "https://example.com/audio-love-expressions-ha.mp3",
            "https://example.com/image-love-expressions-ha.png"
          ]
        },
        {
          "id": "french",
          "name": "French",
          "content": "Exprimer l'amour en français est une chose délicate et charmante. Voici quelques façons de le faire, avec des traductions en anglais.",
          "examples": [
            {
              "exampleName": "Déclarer son Amour",
              "exampleList": [
                {
                  "phrase": "Je t'aime",
                  "translation": "I love you"
                ...
                {
                  "phrase": "Tu es tout pour moi",
                  "translation": "You mean the world to me"
                },
                {
                  "phrase": "Mon cœur t'appartient",
                  "translation": "My heart belongs to you"
                }
              ]
            },
            {
              "exampleName": "Expressions Romantiques",
              "exampleList": [
                {
                  "phrase": "Tu es ma vie",
                ...
                {
                  "phrase": "Je suis si heureux quand je suis avec toi",
                  "translation": "I am so happy when I am with you"
                }
              ]
            },
            {
              "exampleName": "Idiomes d'Amour",
              "exampleList": [
                {
                ...
                {
                  "phrase": "Vivre d'amour et d'eau fraiche",
          ...
          "keyVocabulary": [
            {"phrase": "Je t'aime", "usage": "A direct expression of love", "translation": "I love you"},
            {"phrase": "Tu es tout pour moi", "usage": "To emphasize someone's importance", "translation": "You mean the world to me"},
            {"phrase": "Mon cœur t'appartient", "usage": "To express exclusive affection", "translation": "My heart belongs to you"}
          ],
          "media": [
            "https://example.com/audio-love-expressions-fr.mp3",
            "https://example.com/image-love-expressions-fr.png"
          ]
        },
        {
          "id": "spanish",
          "name": "Spanish",
          "content": "Expresar el amor en español es algo hermoso y variado. Aquí tienes algunas maneras de hacerlo, con traducciones al inglés.",
          "examples": [
            {
              "exampleName": "Declarar el Amor",
              "exampleList": [
                {
                  "phrase": "Te amo",
                  "translation": "I love you"
                ...
                {
                  "phrase": "Eres todo para mí",
                  "translation": "You mean the world to me"
                },
                {
                  "phrase": "Mi corazón es tuyo",
                  "translation": "My heart belongs to you"
                }
              ]
            },
            {
              "exampleName": "Expresiones Románticas",
              "exampleList": [
                {
                  "phrase": "Eres mi todo",
                  "translation": "You are my everything"
                ...
                {
                  "phrase": "Estoy tan feliz cuando estoy contigo",
                  "translation": "I am so happy when I am with you"
                }
              ]
            },
            {
              "exampleName": "Idiomas del Amor",
              "exampleList": [
                {
                  "phrase": "Enamorarse a primera vista",
                  "translation": "To fall in love at first sight"
                },
                {
                  "phrase": "El amor es ciego, pero los vecinos no",
          ...
          "keyVocabulary": [
            {"phrase": "Te amo", "usage": "A direct expression of love", "translation": "I love you"},
            {"phrase": "Eres todo para mí", "usage": "To emphasize someone's importance", "translation": "You mean the world to me"},
            {"phrase": "Mi corazón es tuyo", "usage": "To express exclusive affection", "translation": "My heart belongs to you"}
          ],
          "media": [
            "https://example.com/audio-love-expressions-es.mp3",
            "https://example.com/image-love-expressions-es.png"
          ]
        },
      ],
    },
      ...
      languages: [
        {
          "id": "english",
          "name": "English",
          "content": "Knowing how to buy things is essential for everyday life, especially when shopping. Here are some common phrases and scenarios involved in buying things in English.",
          "examples": [
            {
              "exampleName": "Asking About Prices",
              "exampleList": [
                {
                ...
                {
                  "phrase": "What is the price of [Item]?",
                  "translation": "What is the cost of [Item]?"
                },
                {
                  "phrase": "Is this on sale?",
                  "translation": "Is this item discounted?"
                },
                {
                  "phrase": "Do you have any discounts?",
                  "translation": "Are there any available discounts?"
                },
                {
                  "phrase": "Can I get a better price?",
                  "translation": "Is there room for negotiation on the price?"
                }
              ]
            },
            {
              "exampleName": "Making a Purchase",
              "exampleList": [
                {
                  "phrase": "I would like to buy this.",
                  "translation": "I want to purchase this item."
                },
                {
                  "phrase": "I’ll take it.",
                  "translation": "I have decided to buy it."
                },
                {
                  "phrase": "Can I pay by card?",
                  "translation": "Is it possible to pay with a credit or debit card?"
                },
                {
                  "phrase": "Do you accept cash?",
                  "translation": "Can I pay with cash?"
                },
                {
                  "phrase": "Where can I find the checkout?",
                  "translation": "Where is the payment area?"
                }
              ]
            },
            {
              "exampleName": "Asking for Help",
              "exampleList": [
                {
                  "phrase": "Can you help me find [Item]?",
                  "translation": "Could you assist me in locating [Item]?"
                },
                {
                  "phrase": "Where can I find [Item]?",
                  "translation": "Can you tell me where [Item] is located?"
                },
                {
                  "phrase": "Do you have this in a different size/color?",
                  "translation": "Is this available in another size or color?"
                },
                {
                  "phrase": "Can you recommend a good [Product]?",
                  "translation": "Could you suggest a good [Product]?"
                }
              ]
            },
            {
              "exampleName": "Asking for Receipts and Returns",
              "exampleList": [
                {
                  "phrase": "Can I have a receipt, please?",
                  "translation": "Would you provide me with a receipt?"
                },
                {
                  "phrase": "What is your return policy?",
                  "translation": "How do I return items?"
                },
                {
                  "phrase": "Can I return this if it doesn't fit?",
                  "translation": "Is it possible to return this if it's not the right size?"
                }
              ]
            }
          ],
          "keyVocabulary": [
            {
              "phrase": "How much",
              "usage": "To ask about the cost of an item",
              "translation": "Indicates an inquiry about price"
            },
            {
              "phrase": "I would like to buy",
              "usage": "To express intent to purchase something",
              "translation": "A phrase used when making a purchase"
            },
            {
              "phrase": "Can I pay by card?",
              "usage": "To inquire about payment methods",
              "translation": "Asks if card payment is accepted"
            },
            {
              "phrase": "Do you have",
              "usage": "To ask for availability of a product",
              "translation": "Requests information about product availability"
            }
          ],
          "media": [
            "https://example.com/audio-buying-things-en.mp3",
            "https://example.com/image-buying-things-en.png"
          ]
        },
        {
          "id": "hausa",
          "name": "Hausa",
          "content": "Sanin yadda ake sayen kaya yana da mahimmanci a rayuwar yau da kullum, musamman a lokacin siyayya. Ga wasu kalmomi da halaye da suka shafi sayen kaya a Hausa, tare da fassarar Turanci.",
          "examples": [
            {
              "exampleName": "Tambayar Farashi",
              "exampleList": [
                {
                  "phrase": "Nawa ne wannan?",
                  "translation": "How much does this cost?"
                },
                {
                  "phrase": "Mene ne farashin [Kaya]?",
                  "translation": "What is the price of [Item]?"
                },
                {
                  "phrase": "Shin wannan yana kan rangwame?",
                  "translation": "Is this on sale?"
                },
                {
                  "phrase": "Shin kuna da rangwame?",
                  "translation": "Do you have any discounts?"
                },
                {
                  "phrase": "Za a iya samun kudi mafi kyau?",
                  "translation": "Can I get a better price?"
                }
              ]
            },
            {
              "exampleName": "Yin Sayayya",
              "exampleList": [
                {
                  "phrase": "Zan so in sayi wannan.",
                ...
                {
                  "phrase": "Shin zan iya biyan kudi ta katin kudi?",
                  "translation": "Can I pay by card?"
                },
                {
                  "phrase": "Shin kuna karɓan kudi?",
                  "translation": "Do you accept cash?"
                },
                {
                  "phrase": "Ina zan sami wurin biyan kudi?",
                  "translation": "Where can I find the checkout?"
                }
              ]
            },
            {
              "exampleName": "Tambayar Taimako",
              "exampleList": [
                {
                  "phrase": "Za ka iya taimaka mini samun [Kaya]?",
                  "translation": "Can you help me find [Item]?"
                },
                {
                  "phrase": "Ina zan sami [Kaya]?",
                  "translation": "Where can I find [Item]?"
                },
                {
                  "phrase": "Shin kuna da wannan a cikin wani girma/ launi?",
                  "translation": "Do you have this in a different size/color?"
                },
                {
                  "phrase": "Za ka iya ba ni shawara kan kyakkyawan [Kayan]?",
                  "translation": "Can you recommend a good [Product]?"
                }
              ]
            },
            {
              "exampleName": "Tambayoyi kan Rasit da Mayarwa",
              "exampleList": [
                {
                  "phrase": "Zan iya samun rasit, don Allah?",
                  "translation": "Can I have a receipt, please?"
                },
                {
                  "phrase": "Menene tsarin mayarwa?",
                  "translation": "What is your return policy?"
                },
                {
                  "phrase": "Shin zan iya mayar da wannan idan ba ya dace?",
                  "translation": "Can I return this if it doesn't fit?"
                }
              ]
            }
          ],
          ...
          "media": [
            "https://example.com/audio-buying-things-ha.mp3",
            "https://example.com/image-buying-things-ha.png"
          ]
        },
        {
          "id": "french",
          "name": "French",
          "content": "Savoir comment acheter des choses est essentiel dans la vie quotidienne, surtout lors des courses. Voici quelques phrases et scénarios courants liés à l'achat en français, avec des traductions en anglais.",
          "examples": [
            {
              "exampleName": "Demander les Prix",
              "exampleList": [
                {
                ...
                {
                  "phrase": "Quel est le prix de [Article]?",
                  "translation": "What is the price of [Item]?"
                },
                {
                  "phrase": "Est-ce que c'est en solde?",
                  "translation": "Is this on sale?"
                },
                {
                  "phrase": "Avez-vous des réductions?",
                  "translation": "Do you have any discounts?"
                },
                {
                  "phrase": "Puis-je avoir un meilleur prix?",
                  "translation": "Can I get a better price?"
                }
              ]
            },
            {
              "exampleName": "Faire un Achat",
              "exampleList": [
                {
                  "phrase": "Je voudrais acheter ça.",
                  "translation": "I would like to buy this."
                },
                {
                  "phrase": "Je vais le prendre.",
                  "translation": "I’ll take it."
                },
                {
                  "phrase": "Puis-je payer par carte?",
                  "translation": "Can I pay by card?"
                },
                {
                  "phrase": "Acceptez-vous les espèces?",
                  "translation": "Do you accept cash?"
                },
                {
                  "phrase": "Où puis-je trouver la caisse?",
                  "translation": "Where can I find the checkout?"
                }
              ]
            },
            {
              "exampleName": "Demander de l'Aide",
              "exampleList": [
                {
                  "phrase": "Pouvez-vous m'aider à trouver [Article]?",
                  "translation": "Can you help me find [Item]?"
                },
                {
                  "phrase": "Où puis-je trouver [Article]?",
                  "translation": "Where can I find [Item]?"
                },
                {
                  "phrase": "Avez-vous cela dans une autre taille/couleur?",
                  "translation": "Do you have this in a different size/color?"
                },
                {
                  "phrase": "Pouvez-vous recommander un bon [Produit]?",
                  "translation": "Can you recommend a good [Product]?"
                }
              ]
            },
            {
              "exampleName": "Demander des Reçus et des Retours",
              "exampleList": [
                {
                ...
                {
                  "phrase": "Quelle est votre politique de retour?",
                  "translation": "What is your return policy?"
                },
                {
                  "phrase": "Puis-je retourner cela s'il ne me va pas?",
                  "translation": "Can I return this if it doesn't fit?"
                }
              ]
            }
          ...
          "media": [
            "https://example.com/audio-buying-things-fr.mp3",
            "https://example.com/image-buying-things-fr.png"
          ]
        },
        {
          "id": "spanish",
          "name": "Spanish",
          "content": "Saber cómo comprar cosas es esencial en la vida cotidiana, especialmente cuando vas de compras. Aquí tienes algunas frases comunes y escenarios sobre cómo comprar en español, con traducciones al inglés.",
          "examples": [
            {
              "exampleName": "Pedir Precios",
              "exampleList": [
                {
                ...
                {
                  "phrase": "¿Cuál es el precio de [Artículo]?",
                  "translation": "What is the price of [Item]?"
                },
                {
                  "phrase": "¿Está en oferta?",
                  "translation": "Is this on sale?"
                },
                {
                  "phrase": "¿Tienen descuentos?",
                  "translation": "Do you have any discounts?"
                },
                {
                  "phrase": "¿Puedo obtener un mejor precio?",
                  "translation": "Can I get a better price?"
                }
              ]
            },
            {
              "exampleName": "Hacer una Compra",
              "exampleList": [
                {
                  "phrase": "Me gustaría comprar esto.",
                  "translation": "I would like to buy this."
                },
                {
                  "phrase": "Me lo llevo.",
            ...
            {
              "exampleName": "Pedir Ayuda",
              "exampleList": [
                {
                  "phrase": "¿Puedes ayudarme a encontrar [Artículo]?",
                  "translation": "Can you help me find [Item]?"
                },
                {
                  "phrase": "¿Dónde puedo encontrar [Artículo]?",
                  "translation": "Where can I find [Item]?"
                },
                {
                  "phrase": "¿Tienes esto en otro tamaño/color?",
                  "translation": "Do you have this in a different size/color?"
                },
                {
                  "phrase": "¿Puedes recomendar un buen [Producto]?",
                  "translation": "Can you recommend a good [Product]?"
                }
              ]
            },
            {
              "exampleName": "Preguntar por Recibos y Devoluciones",
              "exampleList": [
                {
                  "phrase": "¿Puedo tener un recibo, por favor?",
                  "translation": "Can I have a receipt, please?"
                },
                {
                  "phrase": "¿Cuál es su política de devoluciones?",
                  "translation": "What is your return policy?"
                },
                {
                  "phrase": "¿Puedo devolver esto si no me queda?",
                  "translation": "Can I return this if it doesn't fit?"
                }
              ]
            }
          ...
          "media": [
            "https://example.com/audio-buying-things-es.mp3",
            "https://example.com/image-buying-things-es.png"
          ]
        },
      ],
    },
      ...
      languages: [
        {
          "id": "english",
          "name": "English",
          "content": "Being able to express opinions clearly and respectfully is crucial in both personal interactions and professional environments. Here are some common phrases used to express opinions in English.",
          "examples": [
            {
              "exampleName": "Expressing Personal Opinions",
              "exampleList": [
                "I think that...",
                "In my opinion, ...",
                "I believe that...",
            ...
            {
              "exampleName": "Agreeing with Opinions",
              "exampleList": [
                "I agree with you.",
                "That's a good point.",
            ...
            {
              "exampleName": "Disagreeing with Opinions",
              "exampleList": [
            ...
            {
              "exampleName": "Asking for Opinions",
              "exampleList": [
                "What do you think?",
          ...
          "keyVocabulary": [
            {"phrase": "I think", "usage": "To introduce one's opinion"},
            {"phrase": "In my opinion", "usage": "To clearly state that what follows is one's opinion"},
            {"phrase": "I agree", "usage": "To express agreement with someone else's opinion"},
            {"phrase": "I disagree", "usage": "To express disagreement with someone else's opinion"}
          ],
          "media": [
            "https://example.com/audio-expressing-opinions-en.mp3",
            "https://example.com/image-expressing-opinions-en.png"
          ]
        },
  
        {
          "id": "hausa",
          "name": "Hausa",
          "content": "Iya bayyana ra'ayi cikin bayyananniya da girmamawa wajibi ne a mu'amaloli na kashin kai da na sana'a. Ga wasu kalmomi da ake amfani da su wajen bayyana ra'ayi a Hausa, tare da fassarar Turanci.",
          "examples": [
            {
              "exampleName": "Bayyana Ra'ayoyin Kai",
              "exampleList": [
                {
                  "phrase": "Ina ganin cewa...",
                ...
                {
                  "phrase": "Ina gaskata cewa...",
                  "translation": "I believe that..."
                }
              ]
            },
            {
              "exampleName": "Amincewa da Ra'ayoyi",
              "exampleList": [
                {
                  "phrase": "Na yarda da kai.",
                  "translation": "I agree with you."
                },
                {
                  "phrase": "Kwarai da gaske! Nima wannan ne ra'ayina.",
                  "translation": "Exactly! I was thinking the same thing."
                }
              ]
            },
            {
              "exampleName": "Rashin Amincewa da Ra'ayoyi",
              "exampleList": [
                {
                  "phrase": "Na fahimci inda kake, amma ban yarda ba.",
                  "translation": "I understand where you're coming from, but I disagree."
                }
              ]
            },
            {
              "exampleName": "Tambayar Ra'ayin Wasu",
              "exampleList": [
                {
                  "phrase": "Me kake tunani?",
                  "translation": "What do you think?"
                },
                {
                  "phrase": "Ya kake ji game da wannan?",
          ...
          "keyVocabulary": [
            {"phrase": "Ina ganin", "usage": "To introduce one's opinion", "translation": "I think"},
            {"phrase": "A ra'ayina", "usage": "To clearly state that what follows is one's opinion", "translation": "In my opinion"},
            {"phrase": "Na yarda", "usage": "To express agreement", "translation": "I agree"},
            {"phrase": "Ban yarda ba", "usage": "To express disagreement", "translation": "I disagree"}
          ],
          "media": [
            "https://example.com/audio-expressing-opinions-ha.mp3",
            "https://example.com/image-expressing-opinions-ha.png"
          ]
        },
  
        {
          "id": "french",
          "name": "French",
          "content": "Savoir exprimer clairement et respectueusement ses opinions est crucial dans les interactions personnelles et professionnelles. Voici quelques phrases courantes pour exprimer des opinions en français, avec des traductions en anglais.",
          "examples": [
            {
              "exampleName": "Exprimer des Opinions Personnelles",
              "exampleList": [
                {
                  "phrase": "Je pense que...",
                  "translation": "I think that..."
            ...
            {
              "exampleName": "Être d'Accord avec des Opinions",
              "exampleList": [
                {
                  "phrase": "Je suis d'accord avec vous.",
                  "translation": "I agree with you."
                },
                {
                  "phrase": "C'est un bon point.",
                  "translation": "That's a good point."
                }
              ]
            },
            {
              "exampleName": "Ne pas Être d'Accord avec des Opinions",
              "exampleList": [
                {
                  "phrase": "Je vois ce que vous voulez dire, mais je ne suis pas d'accord.",
                  "translation": "I see your point, but I disagree."
                }
              ]
            },
            {
              "exampleName": "Demander des Opinions",
              "exampleList": [
                {
                  "phrase": "Que pensez-vous?",
                  "translation": "What do you think?"
                },
                {
                  "phrase": "Qu'en pensez-vous?",
                  "translation": "What's your take on this?"
                }
              ]
            }
          ],
          "keyVocabulary": [
            {"phrase": "Je pense", "usage": "To introduce one's opinion", "translation": "I think"},
            {"phrase": "À mon avis", "usage": "To clearly state that what follows is one's opinion", "translation": "In my opinion"},
            {"phrase": "Je suis d'accord", "usage": "To express agreement", "translation": "I agree"},
            {"phrase": "Je ne suis pas d'accord", "usage": "To express disagreement", "translation": "I disagree"}
          ],
          "media": [
            "https://example.com/audio-expressing-opinions-fr.mp3",
            "https://example.com/image-expressing-opinions-fr.png"
          ]
        },
  
        {
          "id": "spanish",
          "name": "Spanish",
          "content": "Poder expresar opiniones de manera clara y respetuosa es crucial tanto en interacciones personales como profesionales. Aquí tienes algunas frases comunes para expresar opiniones en español, con traducciones al inglés.",
          "examples": [
            {
              "exampleName": "Expresar Opiniones Personales",
              "exampleList": [
                {
                  "phrase": "Creo que...",
                  "translation": "I think that..."
            ...
            {
              "exampleName": "Estar de Acuerdo con Opiniones",
              "exampleList": [
                {
                  "phrase": "Estoy de acuerdo contigo.",
                  "translation": "I agree with you."
                },
                {
                  "phrase": "Exactamente! Pensaba lo mismo.",
                  "translation": "Exactly! I was thinking the same thing."
                }
              ]
            },
            {
              "exampleName": "No Estar de Acuerdo con Opiniones",
              "exampleList": [
                {
                  "phrase": "Entiendo tu punto, pero no estoy de acuerdo.",
                  "translation": "I understand your point, but I disagree."
                }
              ]
            },
            {
              "exampleName": "Pidiendo Opiniones",
              "exampleList": [
                {
                  "phrase": "¿Qué piensas?",
                  "translation": "What do you think?"
                ...
                {
                  "phrase": "¿Cuál es tu opinión sobre...?",
                  "translation": "What's your take on...?"
                }
              ]
            }
          ],
          "keyVocabulary": [
            {"phrase": "Creo que", "usage": "To introduce one's opinion", "translation": "I think"},
            {"phrase": "En mi opinión", "usage": "To clearly state that what follows is one's opinion", "translation": "In my opinion"},
            {"phrase": "Estoy de acuerdo", "usage": "To express agreement", "translation": "I agree"},
            {"phrase": "No estoy de acuerdo", "usage": "To express disagreement", "translation": "I disagree"}
          ],
          "media": [
            "https://example.com/audio-expressing-opinions-es.mp3",
            "https://example.com/image-expressing-opinions-es.png"
          ]
        },
      ],
    },
      ...
      languages: [
        {
          "id": "english",
          "name": "English",
          "content": "Idioms and wise sayings are expressions that convey meanings different from the literal interpretation of the words. They offer wisdom and insight and are a fun way to delve into a language. Here are some common English idioms and wise sayings.",
          "examples": [
            {
              "exampleName": "Common Idioms",
              "exampleList": [
                {
            ...
            },
            {
              ...
              "exampleList": [
                ...
                },
                {
                  ...
                  "meaning": "An image can convey more information than a description"
                },
                {
                  "phrase": "The early bird catches the worm",
                  "meaning": "The person who takes the earliest opportunity to do something will have an advantage"
                }
              ]
            }
          ],
          "keyVocabulary": [
            {"phrase": "Idiom", "definition": "A commonly used expression with a meaning different from the literal words"},
            {"phrase": "Wise saying", "definition": "A phrase that offers wisdom or life advice"}
          ],
          "media": [
            "https://example.com/audio-idioms-en.mp3",
            "https://example.com/image-idioms-en.png"
          ]
        },
        {
          "id": "hausa",
          "name": "Hausa",
          "content": "Kalmomin hikima da magana mai ma'ana suna isar da sakonni masu zurfi daga bayani na kalmomin. Suna bayar da hikima da fahimta. Ga wasu daga cikin kalmomin hikima da magana mai ma'ana a Hausa, tare da fassarar Turanci.",
          "examples": [
            {
              "exampleName": "Maganganu na Hikima",
              "exampleList": [
                {
                  "phrase": "Aikin gama ya gama",
                  "translation": "Well begun is half done",
                  "meaning": "Starting a task well sets the stage for a successful completion"
                },
                {
                  "phrase": "Kowane tsuntsu da kiwonsa",
                  "translation": "Every bird has its own flock",
                  "meaning": "Everyone has their own kind of life or destiny"
                }
              ]
            },
            {
              "exampleName": "Karin Magana",
              "exampleList": [
                {
                  "phrase": "Ruwa baya tsami banza",
                  "translation": "Water doesn't turn bitter for no reason",
                  "meaning": "There's always a reason for a change in behavior"
                },
                {
                  "phrase": "Mai rabo baya gajiya",
                  "translation": "The fortunate one never tires",
                  "meaning": "Those with good fortune never give up"
                }
              ]
            }
          ],
          "keyVocabulary": [
            {"phrase": "Kalmomin hikima", "definition": "Expressions that offer wisdom or life advice", "translation": "Wise sayings"},
            {"phrase": "Magana mai ma'ana", "definition": "Expressions with deeper meanings", "translation": "Idioms"}
          ],
          "media": [
            "https://example.com/audio-idioms-ha.mp3",
            "https://example.com/image-idioms-ha.png"
          ]
        },
        {
          "id": "french",
          "name": "French",
          "content": "Les idiomes et les dictons sont des expressions qui transmettent un sens différent de l'interprétation littérale des mots. Ils offrent sagesse et perspicacité. Voici quelques idiomes et dictons français, avec des traductions en anglais.",
          "examples": [
            {
              "exampleName": "Idiomes Communs",
              "exampleList": [
                {
                ...
                },
                {
                  ...
                  "translation": "Give one's tongue to the cat",
                  "meaning": "To give up trying to guess something"
                }
              ]
            },
            {
              "exampleName": "Dictons Sages",
              "exampleList": [
                {
                ...
                },
                {
                  ...
                  "meaning": "Small, consistent efforts lead to success"
                }
              ]
            }
          ],
          "keyVocabulary": [
            {"phrase": "Idiotisme", "definition": "Une expression couramment utilisée avec un sens différent des mots littéraux", "translation": "Idiom"},
            {"phrase": "Dicton sage", "definition": "Une phrase qui offre des conseils ou de la vie", "translation": "Wise saying"}
          ],
          "media": [
            "https://example.com/audio-idioms-fr.mp3",
            "https://example.com/image-idioms-fr.png"
          ]
        },
        {
          "id": "spanish",
          "name": "Spanish",
          "content": "Los modismos y dichos son expresiones que transmiten significados diferentes a la interpretación literal de las palabras. Ofrecen sabiduría e ideas interesantes. Aquí tienes algunos modismos y dichos en español, con traducciones al inglés.",
          "examples": [
            {
              "exampleName": "Modismos Comunes",
              "exampleList": [
                {
            ...
            },
            {
              ...
              "exampleList": [
                ...
                },
                {
                  ...
                  "translation": "God helps the early riser",
          ...
          "keyVocabulary": [
            {"phrase": "Modismo", "definition": "Una expresión usada comúnmente con un significado diferente de las palabras literales", "translation": "Idiom"},
            {"phrase": "Dicho sabio", "definition": "Una frase que ofrece sabiduría o consejos de vida", "translation": "Wise saying"}
          ],
          "media": [
            "https://example.com/audio-idioms-es.mp3",
            "https://example.com/image-idioms-es.png"
          ]
        },
      ],
    },
      ...
      languages: [
        {
          "id": "english",
          "name": "English",
          "content": "Knowing how to ask for and give directions is crucial in everyday life, especially when navigating new places. Here are some common phrases used in English.",
          "examples": [
            {
              "exampleName": "Asking for Directions",
              "exampleList": [
            ...
            {
              "exampleName": "Clarification Questions",
              "exampleList": [
          ...
          "keyVocabulary": [
            {"phrase": "Excuse me", "usage": "To politely get someone's attention"},
            {"phrase": "Turn left/right", "usage": "To give directions to turn"},
            {"phrase": "Go straight ahead", "usage": "To instruct someone to continue forward"},
            {"phrase": "Landmark", "usage": "A recognizable place used for navigation"}
          ],
          "media": [
            "https://example.com/audio-directions-en.mp3",
            "https://example.com/image-directions-en.png"
          ]
        },
        {
          "id": "hausa",
          "name": "Hausa",
          "content": "Sanin yadda ake tambayar hanya da kuma bayyana hanya yana da mahimmanci a rayuwar yau da kullum, musamman a lokacin da kake wurin da ba ka saba zuwa ba. Ga wasu kalmomi na yau da kullum a cikin Hausa, tare da fassarar Turanci.",
          "examples": [
            {
              "exampleName": "Tambayar Hanya",
              "exampleList": [
                {
                  "phrase": "Don Allah, za ka iya nuna mini hanyar zuwa [Wuri]?",
                  "translation": "Please, can you show me the way to [Place]?"
                },
                {
                  "phrase": "Za ka iya fada min yadda zan je [Wuri]?",
                  "translation": "Can you tell me how to get to [Place]?"
                },
                {
                  "phrase": "Ina [Alamar Wuri] mafi kusa?",
                  "translation": "Where is the nearest [Landmark]?"
                },
                {
                  "phrase": "Ta yaya zan je [Wuri] daga nan?",
                  "translation": "How do I get to [Place] from here?"
                },
                {
                  "phrase": "Akwai [Wuri/Alamar Wuri] a nan kusa?",
                  "translation": "Is there a [Place/Landmark] nearby?"
                },
                {
                  "phrase": "Za ka iya nuna mini a taswira?",
                  "translation": "Can you show me on the map?"
                },
                {
                  "phrase": "Wace hanya ce mafi sauri zuwa [Wuri]?",
                  "translation": "What is the quickest way to [Place]?"
                }
              ]
            },
            {
              "exampleName": "Bayar da Hanya",
              "exampleList": [
                {
                  "phrase": "Ka tafi kai tsaye sama da kwana biyu.",
                  "translation": "Go straight ahead for two blocks."
                },
                {
                  "phrase": "Juya hagu/dama a wurin fitila.",
                  "translation": "Turn left/right at the traffic lights."
                },
                {
                  "phrase": "Ka dauki farko/na biyu hagu/dama.",
                  "translation": "Take the first/second left/right."
                },
                {
                  "phrase": "Yana gefen hagu/dama.",
                  "translation": "It's on your left/right."
                },
                {
                  "phrase": "Ka wuce [Alamar Wuri] kuma za ka gan shi.",
                  "translation": "Go past the [Landmark] and you will see it."
                },
                {
                  "phrase": "Yana a fadin/opposite da [Wuri].",
                  "translation": "It's across from/opposite the [Place]."
                },
                {
                  "phrase": "Ba za ka rasa shi ba.",
                  "translation": "You can't miss it."
                }
              ]
            },
            {
              "exampleName": "Tambayoyin Karin Bayani",
              "exampleList": [
                {
                  "phrase": "Za ka iya maimaitawa, don Allah?",
                  "translation": "Could you repeat that, please?"
                },
                {
                  "phrase": "Shin ina bukatar daukar bas ko jirgin kasa?",
                  "translation": "Do I need to take a bus or train?"
                },
                {
                  "phrase": "Shin yana nesa daga nan?",
                  "translation": "Is it within walking distance?"
                },
                {
                  "phrase": "Zan iya tafiya daga nan?",
                  "translation": "Can I walk there from here?"
                },
                {
                  "phrase": "Zai dauki lokaci mai tsawo don isa can?",
                  "translation": "How long will it take to get there?"
                },
                {
                  "phrase": "Shin yana cikin nesa na tafiya?",
          ...
          "keyVocabulary": [
            {
              "phrase": "Don Allah",
              "usage": "To politely get someone's attention or request help",
              "translation": "Please"
            },
            {
              "phrase": "Juya hagu/dama",
              "usage": "To give directions to turn left/right",
              "translation": "Turn left/right"
            },
            {
              "phrase": "Ka tafi kai tsaye",
              "usage": "To instruct someone to continue forward",
              "translation": "Go straight ahead"
            },
            {
              "phrase": "Alamar Wuri",
              "usage": "A recognizable place used for navigation",
              "translation": "Landmark"
            }
          ],
          "media": [
            "https://example.com/audio-directions-ha.mp3",
            "https://example.com/image-directions-ha.png"
          ]
        },
        {
          "id": "french",
          "name": "French",
          "content": "Savoir comment demander et donner des directions est crucial dans la vie quotidienne, surtout lorsque vous explorez de nouveaux endroits. Voici quelques phrases courantes en français, avec des traductions en anglais.",
          "examples": [
            {
              "exampleName": "Demander des Directions",
              "exampleList": [
                {
                  "phrase": "Excusez-moi, pouvez-vous me dire comment aller à [Endroit]?",
                  "translation": "Excuse me, can you tell me how to get to [Place]?"
                },
                {
                  "phrase": "Pourriez-vous m'indiquer le chemin vers [Endroit]?",
                  "translation": "Could you direct me to [Place]?"
                },
                {
                  "phrase": "Où se trouve le [Point de Repère/Endroit] le plus proche?",
                  "translation": "Where is the nearest [Landmark/Place]?"
                },
                {
                  "phrase": "Comment puis-je aller à [Endroit] à partir d'ici?",
                  "translation": "How do I get to [Place] from here?"
                },
                {
                  "phrase": "Y a-t-il un [Point de Repère/Endroit] à proximité?",
                  "translation": "Is there a [Landmark/Place] nearby?"
                },
                {
                ...
                {
                  "phrase": "Quel est le chemin le plus rapide pour aller à [Endroit]?",
                  "translation": "What is the quickest way to [Place]?"
                }
              ]
            },
            {
              "exampleName": "Donner des Directions",
              "exampleList": [
                {
                  "phrase": "Allez tout droit pendant deux pâtés de maisons.",
                  "translation": "Go straight ahead for two blocks."
                },
                {
                  "phrase": "Tournez à gauche/droite au feu.",
                  "translation": "Turn left/right at the traffic lights."
                },
                {
                  "phrase": "Prenez la première/deuxième à gauche/droite.",
                  "translation": "Take the first/second left/right."
                },
                {
                  "phrase": "C'est sur votre gauche/droite.",
                  "translation": "It's on your left/right."
                },
                {
                  "phrase": "Passez devant le [Point de Repère] et vous le verrez.",
                  "translation": "Go past the [Landmark] and you will see it."
                },
                {
                  "phrase": "C'est en face du [Endroit].",
                  "translation": "It's across from the [Place]."
                },
                {
                  "phrase": "Vous ne pouvez pas le manquer.",
                  "translation": "You can't miss it."
                }
              ]
            },
            {
              "exampleName": "Questions de Clarification",
              "exampleList": [
                {
                  "phrase": "Pourriez-vous répéter, s'il vous plaît?",
                  "translation": "Could you repeat that, please?"
                },
                {
                  "phrase": "Dois-je prendre un bus ou un train?",
                  "translation": "Do I need to take a bus or train?"
                },
                {
                  "phrase": "Est-ce à distance de marche?",
                  "translation": "Is it within walking distance?"
                },
                {
                ...
                {
                  "phrase": "Est-ce loin d'ici?",
                  "translation": "Is it far from here?"
                },
                {
                  "phrase": "Puis-je y aller à pied à partir d'ici?",
                  "translation": "Can I walk there from here?"
                }
              ]
            }
          ...
          "keyVocabulary": [
            {
              "phrase": "Excusez-moi",
              "usage": "To politely get someone's attention",
              "translation": "Excuse me"
            },
            {
              "phrase": "Tournez à gauche/droite",
              "usage": "To give directions to turn left/right",
              "translation": "Turn left/right"
            },
            {
              "phrase": "Allez tout droit",
              "usage": "To instruct someone to continue forward",
              "translation": "Go straight ahead"
            },
            {
              "phrase": "Point de Repère",
              "usage": "A recognizable place used for navigation",
              "translation": "Landmark"
            }
          ],
          "media": [
            "https://example.com/audio-directions-fr.mp3",
            "https://example.com/image-directions-fr.png"
          ]
        },
        {
          "id": "spanish",
          "name": "Spanish",
          "content": "Saber cómo pedir y dar direcciones es crucial en la vida cotidiana, especialmente cuando te encuentras en lugares nuevos. Aquí tienes algunas frases comunes en español, con traducciones al inglés.",
          "examples": [
            {
              "exampleName": "Pedir Direcciones",
              "exampleList": [
                {
                  "phrase": "Disculpe, ¿puede decirme cómo llegar a [Lugar]?",
                  "translation": "Excuse me, can you tell me how to get to [Place]?"
                },
                {
                  "phrase": "¿Podría indicarme el camino a [Lugar]?",
                  "translation": "Could you direct me to [Place]?"
                },
                {
                  "phrase": "¿Dónde está el/la [Punto de Referencia/Lugar] más cercano/a?",
                  "translation": "Where is the nearest [Landmark/Place]?"
                },
                {
                  "phrase": "¿Cómo llego a [Lugar] desde aquí?",
                  "translation": "How do I get to [Place] from here?"
                },
                {
                  "phrase": "¿Hay un/a [Punto de Referencia/Lugar] cerca?",
                  "translation": "Is there a [Landmark/Place] nearby?"
                },
                {
                  "phrase": "¿Puede mostrarme en el mapa?",
                  "translation": "Can you show me on the map?"
                },
                {
                  "phrase": "¿Cuál es la manera más rápida de llegar a [Lugar]?",
                  "translation": "What is the quickest way to [Place]?"
                }
              ]
            },
            {
              "exampleName": "Dar Direcciones",
              "exampleList": [
                {
                  "phrase": "Siga recto dos cuadras.",
                  "translation": "Go straight ahead for two blocks."
                },
                {
                  "phrase": "Gire a la izquierda/derecha en el semáforo.",
                  "translation": "Turn left/right at the traffic lights."
                },
                {
                  "phrase": "Tome la primera/segunda a la izquierda/derecha.",
                  "translation": "Take the first/second left/right."
                },
                {
                  "phrase": "Está a su izquierda/derecha.",
                  "translation": "It's on your left/right."
                },
                {
                  "phrase": "Pase el/la [Punto de Referencia] y lo/la verá.",
                  "translation": "Go past the [Landmark] and you will see it."
                },
                {
                  "phrase": "Está frente al [Lugar].",
                  "translation": "It's across from the [Place]."
                },
                {
                  "phrase": "No puede perderlo/la.",
                  "translation": "You can't miss it."
                }
              ]
            },
            {
              "exampleName": "Preguntas de Clarificación",
              "exampleList": [
                {
                  "phrase": "¿Puede repetir eso, por favor?",
                  "translation": "Could you repeat that, please?"
                },
                {
                  "phrase": "¿Necesito tomar un autobús o tren?",
                  "translation": "Do I need to take a bus or train?"
                },
                {
                  "phrase": "¿Está a una distancia caminable?",
                  "translation": "Is it within walking distance?"
                },
                {
                  "phrase": "¿Cuánto tiempo tardará en llegar allí?",
                  "translation": "How long will it take to get there?"
                },
                {
                  "phrase": "¿Está lejos de aquí?",
                  "translation": "Is it far from here?"
                },
                {
                  "phrase": "¿Puedo caminar hasta allí desde aquí?",
                  "translation": "Can I walk there from here?"
                }
              ]
            }
          ...
          "keyVocabulary": [
            ...
            {
              "phrase": "Gire a la izquierda/derecha",
              "usage": "To give directions to turn left/right",
              "translation": "Turn left/right"
            },
            {
            ...
            {
              "phrase": "Punto de Referencia",
              "usage": "A recognizable place used for navigation",
              "translation": "Landmark"
            }
          ],
          "media": [
            "https://example.com/audio-directions-es.mp3",
            "https://example.com/image-directions-es.png"
          ]
        },
      ]
    }
    ...
    languages: [
      {
        "id": "english",
        "name": "English",
        "content": "Introducing yourself is a crucial skill in any language. Here are some common ways to introduce yourself in English, along with examples and tips.",
        "examples": [
          {
            "exampleName": "Formal Introductions",
            "exampleList": [
              {
                "phrase": "Hello, my name is [Name], and I am the [Job Title] at [Company].",
                "meaning": "A formal introduction including name, job title, and company."
              },
              {
                "phrase": "Good morning, I’m [Name], the new [Job Title] here.",
                "meaning": "A formal greeting with introduction of name and job title."
              }
            ]
          },
          {
            "exampleName": "Informal Introductions",
            "exampleList": [
              {
                "phrase": "Hi, I’m [Name]. Nice to meet you!",
                "meaning": "A casual introduction suitable for social or informal settings."
              },
              {
                "phrase": "Hey, I’m [Name]. Just started today.",
                "meaning": "A casual introduction suitable for new colleagues or classmates."
              }
            ]
          },
          {
            "exampleName": "Structured Introductions",
            "exampleList": [
              {
                "phrase": "Hello everyone I’m so excited to be here today. My name is [Name], and I’m currently based in [Location].",
                "meaning": "Starting with a greeting and showing excitement or gratitude."
              },
              {
                "phrase": "First, I’d like to thank you for taking the time to meet with me today. My name is [Name], and I’m a [Job Title] with [Company].",
                "meaning": "Expressing gratitude before introducing oneself, suitable for interviews."
              }
            ]
          }
        ],
        "stepsForIntroduction": [
          {
            "step": "Greet Your Audience and Show Excitement or Gratitude",
            "example": "Hello everyone I’m so excited to be here today."
          },
          {
            "step": "Share Your Name and Relevant Information About Yourself",
            "example": "My name is [Name], and I’m currently based in [Location]."
          },
          {
            "step": "Share What You Do or Other Interesting Information About Yourself",
            "example": "I’m a project manager with over ten years of experience in various industries."
          },
          {
            "step": "Mention What You’re Hoping to Contribute or Learn",
            "example": "Over the next few hours, I’m hoping to discover new networking opportunities."
          },
          {
            "step": "Ask a Question to Invite Conversation (if relevant)",
            "example": "What about you all? What brings you here today?"
          }
        ],
        "keyVocabulary": [
          {"phrase": "Hello, my name is", "usage": "To start a formal introduction", "translation": "Formal greeting with name"},
          {"phrase": "Nice to meet you", "usage": "To express politeness after introducing oneself", "translation": "Polite response after introduction"},
          {"phrase": "I’m excited to be here today", "usage": "To show enthusiasm", "translation": "Expressing excitement"}
        ],
        "media": [
          "https://example.com/audio-introducing-yourself-en.mp3",
          "https://example.com/image-introducing-yourself-en.png"
        ]
      },
      {
        "id": "hausa",
        "name": "Hausa",
        "content": "Gabatar da kai a wani yare ne mai mahimmanci a rayuwar yau da kullum, musamman a lokacin siyayya ko aiki. Ga wasu misalan yadda za a gabatar da kai a Hausa, tare da fassarar Turanci.",
        "examples": [
          {
            "exampleName": "Gabatarwa na Hukuma",
            "exampleList": [
              {
                "phrase": "Sannu, sunana ni [Sunan Kai]. Ni ne sabon [Matsayi a Aiki] a nan.",
                "translation": "Hello, my name is [Name], and I am the new [Job Title] here.",
                "meaning": "A formal greeting with introduction of name and job title."
              },
              {
                "phrase": "Sannu kwana, sunana ni [Sunan Kai], kuma ni ne [Matsayi a Aiki] a [Kamfanin].",
                "translation": "Good afternoon, I’m [Name], the [Job Title] at [Company].",
                "meaning": "A formal introduction including name, job title, and company."
              }
            ]
          },
          {
            "exampleName": "Gabatarwa na Yau da Kullun",
            "exampleList": [
              {
                "phrase": "Sannu, sunana ni [Sunan Kai]. Ina faranta da haduwa!",
                "translation": "Hi, I’m [Name]. Nice to meet you!",
                "meaning": "A casual introduction suitable for social or informal settings."
              },
              {
                "phrase": "Sannu, sunana ni [Sunan Kai]. Na fara aiki a yau.",
                "translation": "Hey, I’m [Name]. Just started today.",
                "meaning": "A casual introduction suitable for new colleagues or classmates."
              }
            ]
          },
          {
            "exampleName": "Gabatarwa Mai Tsauri",
            "exampleList": [
              {
                "phrase": "Sannu kwana zuri Ina faranta da haduwa a yau. Sunana ni [Sunan Kai], kuma ni ne sabon [Matsayi a Aiki] a nan.",
                "translation": "Hello everyone I’m so excited to be here today. My name is [Name], and I’m currently based in [Location].",
                "meaning": "Starting with a greeting and showing excitement or gratitude."
              },
              {
                "phrase": "Da fatan Allah, ina faranta da haduwa da kai a yau. Sunana ni [Sunan Kai], kuma ni ne [Matsayi a Aiki] a [Kamfanin].",
                "translation": "First, I’d like to thank you for taking the time to meet with me today. My name is [Name], and I’m a [Job Title] with [Company].",
                "meaning": "Expressing gratitude before introducing oneself, suitable for interviews."
              }
            ]
          }
        ...
        "stepsForIntroduction": [
          {
            "step": "Sannu Kwana da Kuma Nuna Faranta",
            "example": "Sannu kwana zuri Ina faranta da haduwa a yau."
          },
          {
            "step": "Baya Sunan Kai da Bayanin Kai",
            "example": "Sunana ni [Sunan Kai], kuma ni ne sabon [Matsayi a Aiki] a nan."
          },
          {
            "step": "Baya Aiki Ko Bayanin Dabam",
            "example": "Ni ne [Matsayi a Aiki] tare da shekaru goma na fannin daban-daban."
          },
          {
            "step": "Mention What You’re Hoping to Contribute or Learn",
            "example": "A ranar nan, ina faranta da gano sababbin damarai na shirye-shirye."
          },
          {
            "step": "Tambaya Don Yada Magana (idai ta dace)",
            "example": "Me kake na kai? Me kake ya kawo kai nan?"
          }
        ],
        "keyVocabulary": [
          {"phrase": "Sannu, sunana ni", "usage": "To start a formal introduction", "translation": "Hello, my name is"},
          {"phrase": "Ina faranta da haduwa", "usage": "To express politeness after introducing oneself", "translation": "Nice to meet you"},
          {"phrase": "Ina faranta da haduwa a yau", "usage": "To show enthusiasm", "translation": "I’m excited to be here today"}
        ],
        "media": [
          "https://example.com/audio-introducing-yourself-ha.mp3",
          "https://example.com/image-introducing-yourself-ha.png"
        ]
      },
      {
        "id": "french",
        "name": "French",
        "content": "Se présenter est une compétence essentielle dans n'importe quel contexte, qu'il s'agisse d'un lieu de travail ou d'une rencontre sociale. Voici quelques façons de vous présenter en français, avec des exemples et des conseils.",
        "examples": [
          {
            "exampleName": "Présentations Formelles",
            "exampleList": [
              {
                "phrase": "Bonjour, je m'appelle [Nom]. Je suis le nouveau [Titre de Poste] ici.",
                "translation": "Hello, my name is [Name], and I am the new [Job Title] here.",
                "meaning": "A formal greeting with introduction of name and job title."
              },
              {
                "phrase": "Bonjour, je m'appelle [Nom], et je suis [Titre de Poste] chez [Entreprise].",
                "translation": "Good morning, I’m [Name], the [Job Title] at [Company].",
                "meaning": "A formal introduction including name, job title, and company."
              }
            ]
          },
          {
            "exampleName": "Présentations Informelles",
            "exampleList": [
              {
                "phrase": "Salut, je m'appelle [Nom]. Enchanté(e) de vous rencontrer!",
                "translation": "Hi, I’m [Name]. Nice to meet you!",
                "meaning": "A casual introduction suitable for social or informal settings."
              },
              {
                "phrase": "Salut, je m'appelle [Nom]. Je viens de commencer aujourd'hui.",
                "translation": "Hey, I’m [Name]. Just started today.",
                "meaning": "A casual introduction suitable for new colleagues or classmates."
              }
            ]
          ...
          {
            "exampleName": "Présentations Structurées",
            "exampleList": [
              {
                "phrase": "Bonjour à tous ! Je suis ravi(e) d'être ici aujourd'hui. Mon nom est [Nom], et je suis actuellement basé(e) à [Lieu].",
                "translation": "Hello everyone I’m so excited to be here today. My name is [Name], and I’m currently based in [Location].",
                "meaning": "Starting with a greeting and showing excitement or gratitude."
              },
              {
                "phrase": "Merci de prendre le temps de me rencontrer aujourd'hui. Mon nom est [Nom], et je suis [Titre de Poste] chez [Entreprise].",
                "translation": "First, I’d like to thank you for taking the time to meet with me today. My name is [Name], and I’m a [Job Title] with [Company].",
                "meaning": "Expressing gratitude before introducing oneself, suitable for interviews."
              }
            ]
        ...
        "stepsForIntroduction": [
          {
            "step": "Saluer Votre Audience et Montrer Votre Enthousiasme",
            "example": "Bonjour à tous ! Je suis ravi(e) d'être ici aujourd'hui."
          },
          {
            "step": "Partager Votre Nom et Informations Pertinentes",
            "example": "Mon nom est [Nom], et je suis actuellement basé(e) à [Lieu]."
          },
          {
            "step": "Partager Ce Que Vous Faites ou Autres Informations Intéressantes",
            "example": "Je suis un(e) manager de projet avec plus de dix ans d'expérience dans divers secteurs."
          },
          {
            "step": "Mentionner Ce Que Vous Espérez Contribuer ou Apprendre",
            "example": "Au cours des prochaines heures, j'espère découvrir de nouvelles opportunités de networking."
          },
          {
            "step": "Poser une Question pour Inviter la Conversation (si pertinent)",
            "example": "Et vous tous ? Qu'est-ce qui vous amène ici aujourd'hui ?"
          }
        ],
        "keyVocabulary": [
          {"phrase": "Bonjour, je m'appelle", "usage": "To start a formal introduction", "translation": "Hello, my name is"},
          {"phrase": "Enchanté(e) de vous rencontrer", "usage": "To express politeness after introducing oneself", "translation": "Nice to meet you"},
          {"phrase": "Je suis ravi(e) d'être ici aujourd'hui", "usage": "To show enthusiasm", "translation": "I’m excited to be here today"}
        ],
        "media": [
          "https://example.com/audio-introducing-yourself-fr.mp3",
          "https://example.com/image-introducing-yourself-fr.png"
        ]
      },
      {
        "id": "spanish",
        "name": "Spanish",
        "content": "Presentarse es una habilidad crucial en cualquier contexto, ya sea en el lugar de trabajo o en una reunión social. Aquí tienes algunas formas de presentarte en español, con ejemplos y consejos.",
        "examples": [
          {
            "exampleName": "Presentaciones Formales",
            "exampleList": [
              {
                "phrase": "Buenos días, me llamo [Nombre] y soy el nuevo [Título de Puesto] aquí.",
                "translation": "Good morning, I’m [Name], and I am the new [Job Title] here.",
                "meaning": "A formal greeting with introduction of name and job title."
              },
              {
                "phrase": "Buenos días, me llamo [Nombre] y soy [Título de Puesto] en [Empresa].",
                "translation": "Good morning, I’m [Name], the [Job Title] at [Company].",
                "meaning": "A formal introduction including name, job title, and company."
              }
            ]
          ...
          {
            "exampleName": "Presentaciones Informales",
            "exampleList": [
              {
                "phrase": "Hola, me llamo [Nombre]. Encantado/a de conocerte!",
                "translation": "Hi, I’m [Name]. Nice to meet you!",
                "meaning": "A casual introduction suitable for social or informal settings."
              },
              {
                "phrase": "Hola, me llamo [Nombre]. Acabo de empezar hoy.",
                "translation": "Hey, I’m [Name]. Just started today.",
                "meaning": "A casual introduction suitable for new colleagues or classmates."
              }
            ]
          ...
          {
            "exampleName": "Presentaciones Estructuradas",
            "exampleList": [
              {
                "phrase": "Buenos días a todos. Estoy emocionado/a de estar aquí hoy. Me llamo [Nombre] y actualmente vivo en [Lugar].",
                "translation": "Hello everyone I’m so excited to be here today. My name is [Name], and I’m currently based in [Location].",
                "meaning": "Starting with a greeting and showing excitement or gratitude."
              },
              {
                "phrase": "Primero, quiero agradecerles por tomarse el tiempo de reunirse conmigo hoy. Me llamo [Nombre] y soy [Título de Puesto] en [Empresa].",
                "translation": "First, I’d like to thank you for taking the time to meet with me today. My name is [Name], and I’m a [Job Title] with [Company].",
                "meaning": "Expressing gratitude before introducing oneself, suitable for interviews."
              }
            ]
        ...
        "stepsForIntroduction": [
          {
            "step": "Saludar a Su Audiencia y Mostrar Entusiasmo",
            "example": "Buenos días a todos. Estoy emocionado/a de estar aquí hoy."
          },
          {
            "step": "Compartir Su Nombre y Información Relevante",
            "example": "Me llamo [Nombre] y actualmente vivo en [Lugar]."
          },
          {
            "step": "Compartir Lo Que Hace o Otra Información Interesante",
            "example": "Soy un/a gerente de proyecto con más de diez años de experiencia en varios sectores."
          },
          {
            "step": "Mencionar Lo Que Espera Contribuir o Aprender",
            "example": "En las próximas horas, espero descubrir nuevas oportunidades de networking."
          },
          {
            "step": "Preguntar para Invitar la Conversación (si es relevante)",
            "example": "¿Y ustedes todos? ¿Qué los trae aquí hoy?"
          }
        ],
        "keyVocabulary": [
          {"phrase": "Buenos días, me llamo", "usage": "To start a formal introduction", "translation": "Good morning, my name is"},
          {"phrase": "Encantado/a de conocerte", "usage": "To express politeness after introducing oneself", "translation": "Nice to meet you"},
          {"phrase": "Estoy emocionado/a de estar aquí hoy", "usage": "To show enthusiasm", "translation": "I’m excited to be here today"}
        ],
        "media": [
          "https://example.com/audio-introducing-yourself-es.mp3",
          "https://example.com/image-introducing-yourself-es.png"
        ]
      },
    ],
  },
    ...
    languages: [
      {
        "id": "english",
        "name": "English",
        "content": "Understanding numbers, days of the week, and dates is essential for everyday communication. Here are some common ways to express these in English.",
        "examples": [
          {
            "exampleName": "Numbers",
            "exampleList": [
          ...
          },
          {
            ...
            "exampleList": [
              {
                "phrase": "Today is October 5, 2023",
                "meaning": "Expressing the date for October 5, 2023"
              },
              {
                "phrase": "The meeting is on November 15th",
                "meaning": "Expressing a future date"
              },
              {
                "phrase": "My birthday is on December 25th",
                "meaning": "Expressing a specific date"
              }
            ]
          }
        ],
        "keyVocabulary": [
          {"phrase": "One", "usage": "The number 1"},
          {"phrase": "Two", "usage": "The number 2"},
          {"phrase": "Monday", "usage": "The first day of the week"},
          {"phrase": "October 5, 2023", "usage": "Expressing the date"}
        ],
        "media": [
          "https://example.com/audio-numbers-days-dates-en.mp3",
          "https://example.com/image-numbers-days-dates-en.png"
        ]
      },
      {
        "id": "hausa",
        "name": "Hausa",
        "content": "Fahimta lambu, rana da kunne yana da mahimmanci a tattara alakan. Ga wasu misalan yadda ake bayyana lambu, rana da kunne a Hausa, tare da fassarar Turanci.",
        "examples": [
          {
            "exampleName": "Lambu",
            "exampleList": [
          ...
          },
          {
            ...
            "exampleList": [
              {
                "phrase": "Yau yana oktoba rana 5, 2023",
                "translation": "Today is October 5, 2023",
                "meaning": "Expressing the date for October 5, 2023"
              },
              {
                "phrase": "Shawara ta zama a ranar nobemba 15",
                "translation": "The meeting is on November 15th",
                "meaning": "Expressing a future date"
              },
              {
                "phrase": "Wananni na zama a ranar disemba 25",
                "translation": "My birthday is on December 25th",
                "meaning": "Expressing a specific date"
              }
            ]
          }
        ...
        "keyVocabulary": [
          {"phrase": "Daya", "usage": "The number 1", "translation": "One"},
          {"phrase": "Biyu", "usage": "The number 2", "translation": "Two"},
          {"phrase": "Litinin", "usage": "The first day of the week", "translation": "Monday"},
          {"phrase": "Oktoba rana 5, 2023", "usage": "Expressing the date", "translation": "October 5, 2023"}
        ],
        "media": [
          "https://example.com/audio-numbers-days-dates-ha.mp3",
          "https://example.com/image-numbers-days-dates-ha.png"
        ]
      },
      {
        "id": "french",
        "name": "French",
        "content": "Comprendre les nombres, les jours de la semaine et les dates est essentiel pour la communication quotidienne. Voici quelques façons courantes de les exprimer en français.",
        "examples": [
          {
            "exampleName": "Nombres",
            "exampleList": [
          ...
          {
            "exampleName": "Jours de la Semaine",
            "exampleList": [
              {
                "phrase": "Lundi",
                "translation": "Monday",
          ...
          },
          {
            ...
            "exampleList": [
              {
                "phrase": "Aujourd'hui, nous sommes le 5 octobre 2023",
                "translation": "Today is October 5, 2023",
                "meaning": "Expressing the date for October 5, 2023"
              },
              {
                "phrase": "La réunion aura lieu le 15 novembre",
                "translation": "The meeting is on November 15th",
                "meaning": "Expressing a future date"
              },
              {
                "phrase": "Mon anniversaire est le 25 décembre",
                "translation": "My birthday is on December 25th",
                "meaning": "Expressing a specific date"
              }
            ]
        ...
        "keyVocabulary": [
          {"phrase": "Un", "usage": "The number 1", "translation": "One"},
          {"phrase": "Deux", "usage": "The number 2", "translation": "Two"},
          {"phrase": "Lundi", "usage": "The first day of the week", "translation": "Monday"},
          {"phrase": "5 octobre 2023", "usage": "Expressing the date", "translation": "October 5, 2023"}
        ],
        "media": [
          "https://example.com/audio-numbers-days-dates-fr.mp3",
          "https://example.com/image-numbers-days-dates-fr.png"
        ]
      },
      {
        "id": "spanish",
        "name": "Spanish",
        "content": "Comprender los números, los días de la semana y las fechas es esencial para la comunicación diaria. Aquí tienes algunas formas comunes de expresarlos en español.",
        "examples": [
          {
            "exampleName": "Números",
            "exampleList": [
          ...
          },
          {
            ...
            "exampleList": [
              {
                "phrase": "Hoy es 5 de octubre de 2023",
                "translation": "Today is October 5, 2023",
                "meaning": "Expressing the date for October 5, 2023"
              },
              {
                "phrase": "La reunión es el 15 de noviembre",
                "translation": "The meeting is on November 15th",
                "meaning": "Expressing a future date"
              },
              {
                "phrase": "Mi cumpleaños es el 25 de diciembre",
                "translation": "My birthday is on December 25th",
                "meaning": "Expressing a specific date"
              }
            ]
        ...
        "keyVocabulary": [
          {"phrase": "Uno", "usage": "The number 1", "translation": "One"},
          {"phrase": "Dos", "usage": "The number 2", "translation": "Two"},
          {"phrase": "Lunes", "usage": "The first day of the week", "translation": "Monday"},
          {"phrase": "5 de octubre de 2023", "usage": "Expressing the date", "translation": "October 5, 2023"}
        ],
        "media": [
          "https://example.com/audio-numbers-days-dates-es.mp3",
          "https://example.com/image-numbers-days-dates-es.png"
        ]
      },
    ],
  },
    ...
    languages: [
      {
        "id": "english",
        "name": "English",
        "content": "Using polite phrases is essential for effective communication and building relationships. Here are some common polite phrases in English.",
        "examples": [
          {
            "exampleName": "Greetings",
            "exampleList": [
              {
                "phrase": "Hello, how are you?",
                "meaning": "A common greeting to ask about someone's well-being"
              },
              {
                "phrase": "Good morning, good afternoon, good evening",
                "meaning": "Formal greetings for different times of the day"
              }
            ]
          },
          {
            "exampleName": "Showing Gratitude",
            "exampleList": [
              {
                "phrase": "Thank you",
                "meaning": "A common expression of gratitude"
              },
              {
                "phrase": "I appreciate it",
                "meaning": "To show appreciation for something"
              },
              {
                "phrase": "You're welcome",
                "meaning": "A response to thank you"
              }
            ]
          },
          {
            "exampleName": "Apologizing",
            "exampleList": [
              {
                "phrase": "I'm sorry",
                "meaning": "A common apology for a mistake or wrongdoing"
              },
              {
                "phrase": "Excuse me",
                "meaning": "To apologize for interrupting or to get someone's attention"
              },
              {
                "phrase": "Please forgive me",
                "meaning": "A formal apology for a serious mistake"
              }
            ]
          },
          {
            "exampleName": "Making Requests",
            "exampleList": [
              {
              ...
              },
              {
                ...
                "meaning": "A polite way to ask a question"
              },
              {
        ...
        "keyVocabulary": [
          {"phrase": "Hello, how are you?", "usage": "A common greeting to ask about someone's well-being"},
          {"phrase": "Thank you", "usage": "A common expression of gratitude"},
          {"phrase": "I'm sorry", "usage": "A common apology for a mistake or wrongdoing"}
        ],
        "media": [
          "https://example.com/audio-polite-phrases-en.mp3",
          "https://example.com/image-polite-phrases-en.png"
        ]
      },
      {
        "id": "hausa",
        "name": "Hausa",
        "content": "Amfani da kalmomin adabi yana da mahimmanci a tattara alakan da kuma kawo yanayi na abota. Ga wasu misalan kalmomin adabi a Hausa, tare da fassarar Turanci.",
        "examples": [
          {
            "exampleName": "Muryoyi",
            "exampleList": [
              {
                "phrase": "Sannu, yaya ku?",
                "translation": "Hello, how are you?",
                "meaning": "A common greeting to ask about someone's well-being"
              },
              {
                "phrase": "Sannu kwana, sannu rana, sannu yamma",
                "translation": "Good morning, good afternoon, good evening",
                "meaning": "Formal greetings for different times of the day"
              }
            ]
          },
          {
            "exampleName": "Nuna Godiya",
            "exampleList": [
              {
                "phrase": "Na gode",
          ...
          {
            "exampleName": "Yin Tambaya",
            "exampleList": [
              {
                "phrase": "Ko ku taimaka mini?",
              ...
              {
                "phrase": "Ko ku yarda in...?",
                "translation": "Would you mind if I...?",
                "meaning": "A polite way to ask for permission"
              }
            ]
          }
        ...
        "keyVocabulary": [
          {"phrase": "Sannu, yaya ku?", "usage": "A common greeting to ask about someone's well-being", "translation": "Hello, how are you?"},
          {"phrase": "Na gode", "usage": "A common expression of gratitude", "translation": "Thank you"},
          {"phrase": "Na yi kuskure", "usage": "A common apology for a mistake or wrongdoing", "translation": "I'm sorry"}
        ],
        "media": [
          "https://example.com/audio-polite-phrases-ha.mp3",
          "https://example.com/image-polite-phrases-ha.png"
        ]
      },
      {
        "id": "french",
        "name": "French",
        "content": "Utiliser des phrases polies est essentiel pour une communication efficace et pour établir des relations. Voici quelques exemples de phrases polies en français.",
        "examples": [
          {
            "exampleName": "Salutations",
            "exampleList": [
              {
              ...
              {
                "phrase": "Bonne journée, bonne soirée",
                "translation": "Good day, good evening",
                "meaning": "Formal greetings for different times of the day"
              }
            ]
          },
          {
            "exampleName": "Exprimer sa Gratitude",
            "exampleList": [
              {
                "phrase": "Merci",
                "translation": "Thank you",
          ...
          },
          {
            ...
            "exampleList": [
              ...
              {
                "phrase": "Je vous prie de m'excuser",
                "translation": "Please forgive me",
                "meaning": "A formal apology for a serious mistake"
              }
            ]
          ...
          {
            "exampleName": "Faire des Demandes",
            "exampleList": [
              {
              ...
              {
                "phrase": "Puis-je vous demander quelque chose?",
                "translation": "May I ask a question?",
                "meaning": "A polite way to ask a question"
              },
              {
                "phrase": "Est-ce que cela vous dérange si...?",
                "translation": "Would you mind if I...?",
                "meaning": "A polite way to ask for permission"
              }
            ]
        ...
        "keyVocabulary": [
          {"phrase": "Bonjour, comment allez-vous?", "usage": "A common greeting to ask about someone's well-being", "translation": "Hello, how are you?"},
          {"phrase": "Merci", "usage": "A common expression of gratitude", "translation": "Thank you"},
          {"phrase": "Je suis désolé(e)", "usage": "A common apology for a mistake or wrongdoing", "translation": "I'm sorry"}
        ],
        "media": [
          "https://example.com/audio-polite-phrases-fr.mp3",
          "https://example.com/image-polite-phrases-fr.png"
        ]
      },
      {
        "id": "spanish",
        "name": "Spanish",
        "content": "Utilizar frases corteses es esencial para una comunicación efectiva y para establecer relaciones. Aquí tienes algunos ejemplos de frases corteses en español.",
        "examples": [
          {
            "exampleName": "Saludos",
            "exampleList": [
              ...
              {
                "phrase": "Buenos días, buenas tardes, buenas noches",
                "translation": "Good morning, good afternoon, good evening",
                "meaning": "Formal greetings for different times of the day"
              }
            ]
          ...
          {
            "exampleName": "Hacer Peticiones",
            "exampleList": [
              {
                "phrase": "¿Puedes ayudarme?",
                "translation": "Could you please help me?",
                "meaning": "A polite request for assistance"
              },
              {
                "phrase": "¿Puedo preguntar algo?",
                "translation": "May I ask a question?",
                "meaning": "A polite way to ask a question"
              },
              {
                "phrase": "¿Te importaría si...?",
                "translation": "Would you mind if I...?",
                "meaning": "A polite way to ask for permission"
              }
            ]
        ...
        "keyVocabulary": [
          {"phrase": "Hola, ¿cómo estás?", "usage": "A common greeting to ask about someone's well-being", "translation": "Hello, how are you?"},
          {"phrase": "Gracias", "usage": "A common expression of gratitude", "translation": "Thank you"},
          {"phrase": "Lo siento", "usage": "A common apology for a mistake or wrongdoing", "translation": "I'm sorry"}
        ],
        "media": [
          "https://example.com/audio-polite-phrases-es.mp3",
          "https://example.com/image-polite-phrases-es.png"
        ]
      },
    ],
    ...
    languages: [
      {
        "id": "english",
        "name": "English",
        "content": "Narration is a fundamental skill in any language, allowing you to share stories and experiences with others. Here are some common narrative structures and vocabulary in English.",
        "examples": [
          {
            "exampleName": "Introduction",
            "exampleList": [
              {
                "phrase": "Once upon a time, in a small village, there lived a young girl named Sarah.",
                "meaning": "A common way to start a story"
              },
              {
                "phrase": "It was a dark and stormy night, and I was driving home from work.",
                "meaning": "A way to set the scene for a story"
              }
            ]
          },
          {
            ...
            "exampleList": [
              {
                "phrase": "As I walked through the forest, I stumbled upon a hidden clearing.",
                "meaning": "A way to describe a sequence of events"
              },
              {
                "phrase": "The next day, I received a call from an unknown number.",
                "meaning": "A way to continue the story"
              }
            ]
          },
          {
            "exampleName": "Conclusion",
            "exampleList": [
              {
                "phrase": "And so, I learned a valuable lesson that day.",
                "meaning": "A way to conclude a story"
              },
              {
                "phrase": "From that day on, I never forgot the experience.",
                "meaning": "A way to reflect on the story"
              }
            ]
          }
        ],
        "keyVocabulary": [
          {"phrase": "Once upon a time", "usage": "To start a story", "translation": "A long time ago"},
          {"phrase": "As I walked through the forest", "usage": "To describe a sequence of events", "translation": "While I was walking through the forest"},
          {"phrase": "And so", "usage": "To conclude a story", "translation": "Therefore"}
        ],
        "media": [
          "https://example.com/audio-narration-en.mp3",
          "https://example.com/image-narration-en.png"
        ]
      },
      {
        "id": "hausa",
        "name": "Hausa",
        "content": "Labari yana da mahimmanci a kowace yare, domin yana baiwa mutane damar yada labari da kuma bayyana abubuwan da suka faru. Ga wasu misalan tsarin labari da kalmomin Hausa, tare da fassarar Turanci.",
        "examples": [
          {
            "exampleName": "Gabatarwa",
            "exampleList": [
              {
                "phrase": "A lokacin da aka yi, a wata gari karama, akwai wata budurwa mai suna Sara.",
                "translation": "Once upon a time, in a small village, there lived a young girl named Sarah.",
                "meaning": "A common way to start a story"
              },
              {
                "phrase": "A ranar da aka yi, na yi tafiya daga aiki.",
                "translation": "It was a dark and stormy night, and I was driving home from work.",
                "meaning": "A way to set the scene for a story"
              }
            ]
          },
          {
            ...
            "exampleList": [
              {
                "phrase": "A lokacin da na yi tafiya a dajin, na samu wata fili mai tsarki.",
                "translation": "As I walked through the forest, I stumbled upon a hidden clearing.",
                "meaning": "A way to describe a sequence of events"
              },
              {
                "phrase": "Ranar da ta biyo, na samu kiran waya daga wani lambar da ba na sani ba.",
                "translation": "The next day, I received a call from an unknown number.",
                "meaning": "A way to continue the story"
              }
            ]
          },
          {
            ...
            "exampleList": [
              {
                "phrase": "Kuma, na koya darasi mai amfani a ranar da.",
                "translation": "And so, I learned a valuable lesson that day.",
                "meaning": "A way to conclude a story"
              },
              {
                "phrase": "Daga ranar da, ba na manta abin da ya faru ba.",
                "translation": "From that day on, I never forgot the experience.",
                "meaning": "A way to reflect on the story"
              }
            ]
          }
        ...
        "keyVocabulary": [
          {"phrase": "A lokacin da aka yi", "usage": "To start a story", "translation": "A long time ago"},
          {"phrase": "A lokacin da na yi tafiya a dajin", "usage": "To describe a sequence of events", "translation": "While I was walking through the forest"},
          {"phrase": "Kuma", "usage": "To conclude a story", "translation": "Therefore"}
        ],
        "media": [
          "https://example.com/audio-narration-ha.mp3",
          "https://example.com/image-narration-ha.png"
        ]
      },
      {
        "id": "french",
        "name": "French",
        "content": "La narration est une compétence fondamentale dans n'importe quelle langue, permettant de partager des histoires et des expériences avec les autres. Voici quelques exemples de structures narratives et de vocabulaire en français.",
        "examples": [
          {
            "exampleName": "Introduction",
            "exampleList": [
              {
                "phrase": "Il était une fois, dans un petit village, il y avait une jeune fille nommée Sarah.",
                "translation": "Once upon a time, in a small village, there lived a young girl named Sarah.",
                "meaning": "A common way to start a story"
              },
              {
                "phrase": "C'était une nuit sombre et orageuse, et je conduisais pour rentrer chez moi.",
                "translation": "It was a dark and stormy night, and I was driving home from work.",
                "meaning": "A way to set the scene for a story"
              }
            ]
          },
          {
            ...
            "exampleList": [
              {
                "phrase": "Alors que je marchais à travers la forêt, je suis tombé sur une clairière cachée.",
                "translation": "As I walked through the forest, I stumbled upon a hidden clearing.",
                "meaning": "A way to describe a sequence of events"
              },
              {
                "phrase": "Le lendemain, j'ai reçu un appel d'un numéro inconnu.",
                "translation": "The next day, I received a call from an unknown number.",
                "meaning": "A way to continue the story"
              }
            ]
          },
          {
            ...
            "exampleList": [
              {
                "phrase": "Et ainsi, j'ai appris une leçon précieuse ce jour-là.",
                "translation": "And so, I learned a valuable lesson that day.",
                "meaning": "A way to conclude a story"
              },
              {
                "phrase": "À partir de ce jour-là, je n'ai jamais oublié l'expérience.",
                "translation": "From that day on, I never forgot the experience.",
                "meaning": "A way to reflect on the story"
              }
            ]
        ...
        "keyVocabulary": [
          {"phrase": "Il était une fois", "usage": "To start a story", "translation": "A long time ago"},
          {"phrase": "Alors que je marchais à travers la forêt", "usage": "To describe a sequence of events", "translation": "While I was walking through the forest"},
          {"phrase": "Et ainsi", "usage": "To conclude a story", "translation": "Therefore"}
        ],
        "media": [
          "https://example.com/audio-narration-fr.mp3",
          "https://example.com/image-narration-fr.png"
        ]
      },
      {
        "id": "spanish",
        "name": "Spanish",
        "content": "La narración es una habilidad fundamental en cualquier idioma, permitiendo compartir historias y experiencias con los demás. Aquí tienes algunos ejemplos de estructuras narrativas y vocabulario en español.",
        "examples": [
          {
            "exampleName": "Introducción",
            "exampleList": [
              {
                "phrase": "Había una vez, en un pequeño pueblo, había una joven llamada Sara.",
                "translation": "Once upon a time, in a small village, there lived a young girl named Sarah.",
                "meaning": "A common way to start a story"
              },
              {
                "phrase": "Era una noche oscura y tormentosa, y yo conducía para regresar a casa.",
                "translation": "It was a dark and stormy night, and I was driving home from work.",
                "meaning": "A way to set the scene for a story"
              }
            ]
          },
          {
            ...
            "exampleList": [
              {
                "phrase": "Mientras caminaba por el bosque, me encontré con una clara oculta.",
                "translation": "As I walked through the forest, I stumbled upon a hidden clearing.",
                "meaning": "A way to describe a sequence of events"
              },
              {
                "phrase": "Al día siguiente, recibí una llamada de un número desconocido.",
                "translation": "The next day, I received a call from an unknown number.",
                "meaning": "A way to continue the story"
              }
            ]
          ...
          {
            "exampleName": "Conclusión",
            "exampleList": [
              {
                "phrase": "Y así, aprendí una lección valiosa ese día.",
                "translation": "And so, I learned a valuable lesson that day.",
                "meaning": "A way to conclude a story"
              },
              {
                "phrase": "A partir de ese día, nunca olvidé la experiencia.",
                "translation": "From that day on, I never forgot the experience.",
                "meaning": "A way to reflect on the story"
              }
            ]
        ...
        "keyVocabulary": [
          {"phrase": "Había una vez", "usage": "To start a story", "translation": "A long time ago"},
          {"phrase": "Mientras caminaba por el bosque", "usage": "To describe a sequence of events", "translation": "While I was walking through the forest"},
          {"phrase": "Y así", "usage": "To conclude a story", "translation": "Therefore"}
        ],
        "media": [
          "https://example.com/audio-narration-es.mp3",
          "https://example.com/image-narration-es.png"
        ]
      }
    ],
  },
    ...
    languages: [
      {
        "id": "spanish",
        "name": "Spanish",
        "content": "Saber comunicar eficazmente durante una emergencia es crucial. Aquí tienes frases esenciales para varias situaciones de emergencia en español.",
        "examples": [
          {
            "exampleName": "Llamar para Pedir Ayuda",
            "exampleList": [
              {
                "phrase": "¡Socorro!",
                "translation": "Help!",
                "meaning": "A general call for help"
              },
              {
                "phrase": "Llama al 112 (o al número de emergencias local)",
                "translation": "Call 911 (or your local emergency number)",
                "meaning": "Instruction to contact emergency services"
              },
              {
                "phrase": "¡Necesito una ambulancia!",
                "translation": "I need an ambulance!",
                "meaning": "Requesting immediate medical assistance"
              },
              {
                "phrase": "¡Necesito a la policía!",
                "translation": "I need the police!",
                "meaning": "Requesting immediate police assistance"
              },
              {
                "phrase": "¡Necesito bomberos!",
                "translation": "I need a firetruck!",
                "meaning": "Requesting immediate fire department assistance"
              }
            ]
          },
          {
            "exampleName": "Describir la Situación",
            "exampleList": [
              {
                "phrase": "¡Ha habido un accidente!",
                "translation": "There's been an accident!",
                "meaning": "Reporting an accident"
              },
              {
                "phrase": "¡Alguien está herido!",
                "translation": "Someone is injured!",
                "meaning": "Reporting an injury"
              },
              {
                "phrase": "¡Hay un incendio!",
                "translation": "There's a fire!",
                "meaning": "Reporting a fire"
              },
              {
                "phrase": "¡Estoy perdido!",
                "translation": "I'm lost!",
                "meaning": "Reporting being lost"
              },
              {
                "phrase": "¡Me han robado!",
                "translation": "I've been robbed!",
                "meaning": "Reporting a robbery"
              }
            ]
          },
          {
            "exampleName": "Solicitar Ayuda Específica",
            "exampleList": [
              {
                "phrase": "¡Por favor, envíen ayuda inmediatamente!",
                "translation": "Please send help immediately!",
                "meaning": "Urgent request for assistance"
              },
              {
                "phrase": "¡Necesito un médico!",
                "translation": "I need a doctor!",
                "meaning": "Requesting a doctor"
              },
              {
                "phrase": "Mi ubicación es [Ubicación]",
                "translation": "My location is [Location]",
                "meaning": "Providing location information"
              }
            ]
          }
        ],
        "keyVocabulary": [
          {"phrase": "¡Socorro!", "usage": "General call for help", "translation": "Help!"},
          {"phrase": "112", "usage": "Emergency services number (Spain)", "translation": "911 (or your local emergency number)"},
          {"phrase": "¡Hay un incendio!", "usage": "Reporting a fire", "translation": "There's a fire!"}
        ],
        "media": [
          "https://example.com/audio-emergency-es.mp3",
          "https://example.com/image-emergency-es.png"
        ]
      },
      {
        "id": "french",
        "name": "French",
        "content": "Savoir communiquer efficacement en cas d'urgence est crucial. Voici des phrases essentielles pour diverses situations d'urgence en français.",
        "examples": [
          {
            "exampleName": "Appeler à l'Aide",
            "exampleList": [
              {
                "phrase": "Au secours !",
                "translation": "Help!",
              ...
              {
                "phrase": "Appelez le 112 (ou votre numéro d'urgence local)",
                "translation": "Call 911 (or your local emergency number)",
                "meaning": "Instruction to contact emergency services"
              },
              {
                "phrase": "J'ai besoin d'une ambulance !",
                "translation": "I need an ambulance!",
                "meaning": "Requesting immediate medical assistance"
              },
              {
                "phrase": "J'ai besoin de la police !",
                "translation": "I need the police!",
                "meaning": "Requesting immediate police assistance"
              },
              {
                "phrase": "J'ai besoin des pompiers !",
                "translation": "I need a firetruck!",
                "meaning": "Requesting immediate fire department assistance"
              }
            ]
          ...
          {
            "exampleName": "Décrire la Situation",
            "exampleList": [
              {
                "phrase": "Il y a eu un accident !",
                "translation": "There's been an accident!",
                "meaning": "Reporting an accident"
              },
              {
                "phrase": "Quelqu'un est blessé !",
                "translation": "Someone is injured!",
                "meaning": "Reporting an injury"
              },
              {
                "phrase": "Il y a un incendie !",
                "translation": "There's a fire!",
                "meaning": "Reporting a fire"
              },
              {
                "phrase": "Je suis perdu(e) !",
                "translation": "I'm lost!",
                "meaning": "Reporting being lost"
              },
              {
                "phrase": "J'ai été volé(e) !",
                "translation": "I've been robbed!",
                "meaning": "Reporting a robbery"
              }
            ]
          ...
          {
            "exampleName": "Demander une Aide Spécifique",
            "exampleList": [
              {
                "phrase": "Envoyez de l'aide immédiatement !",
                "translation": "Please send help immediately!",
                "meaning": "Urgent request for assistance"
              },
              {
        ...
        "keyVocabulary": [
          {"phrase": "Au secours !", "usage": "General call for help", "translation": "Help!"},
          {"phrase": "112", "usage": "Emergency services number (France)", "translation": "911 (or your local emergency number)"},
          {"phrase": "Il y a un incendie !", "usage": "Reporting a fire", "translation": "There's a fire!"}
        ],
        "media": [
          "https://example.com/audio-emergency-fr.mp3",
          "https://example.com/image-emergency-fr.png"
        ]
      },
      {
        "id": "hausa",
        "name": "Hausa",
        "content": "Sanin yadda za a yi magana da kyau a lokacin gaggawa yana da matukar muhimmanci. Ga wasu kalmomin da za a iya amfani da su a lokacin gaggawa a Hausa.",
        "examples": [
          {
            "exampleName": "Kira Taimako",
            "exampleList": [
              {
                "phrase": "Taimako!",
                "translation": "Help!",
              ...
              {
                "phrase": "Kira 112 (ko lambar gaggawa ta yankinku)",
                "translation": "Call 911 (or your local emergency number)",
                "meaning": "Instruction to contact emergency services"
              },
              {
                "phrase": "Ina bukatar motar asibiti!",
                "translation": "I need an ambulance!",
                "meaning": "Requesting immediate medical assistance"
              },
              {
                "phrase": "Ina bukatar 'yan sanda!",
                "translation": "I need the police!",
                "meaning": "Requesting immediate police assistance"
              },
              {
                "phrase": "Ina bukatar jami'an kashe gobara!",
                "translation": "I need a firetruck!",
                "meaning": "Requesting immediate fire department assistance"
              }
            ]
          ...
          {
            "exampleName": "Bayyana Halin Da Ake Ciki",
            "exampleList": [
              {
                "phrase": "Hadari ya faru!",
                "translation": "There's been an accident!",
                "meaning": "Reporting an accident"
              },
              {
                "phrase": "Wani ya ji rauni!",
                "translation": "Someone is injured!",
                "meaning": "Reporting an injury"
              },
              {
                "phrase": "Wuta ta tashi!",
                "translation": "There's a fire!",
                "meaning": "Reporting a fire"
              },
              {
          ...
          {
            "exampleName": "Bukatar Taimakon Musamman",
            "exampleList": [
              {
                "phrase": "Da fatan za a taimaka mini nan take!",
                "translation": "Please send help immediately!",
                "meaning": "Urgent request for assistance"
              },
              {
                "phrase": "Ina bukatar likita!",
                "translation": "I need a doctor!",
                "meaning": "Requesting a doctor"
              },
              {
                "phrase": "Wurin da nake shine [Wuri]",
                "translation": "My location is [Location]",
                "meaning": "Providing location information"
              }
            ]
        ...
        "keyVocabulary": [
          {"phrase": "Taimako!", "usage": "General call for help", "translation": "Help!"},
          {"phrase": "112", "usage": "Emergency services number (Nigeria)", "translation": "911 (or your local emergency number)"},
          {"phrase": "Wuta ta tashi!", "usage": "Reporting a fire", "translation": "There's a fire!"}
        ],
        "media": [
          "https://example.com/audio-emergency-ha.mp3",
          "https://example.com/image-emergency-ha.png"
        ]
      },
      {
        "id": "english",
        "name": "English",
        "content": "Knowing how to communicate effectively during emergencies is crucial.  Here are essential phrases for various emergency situations in English.",
        "examples": [
          {
            "exampleName": "Calling for Help",
            "exampleList": [
              {
                "phrase": "Help!",
                "meaning": "A general call for help"
              ...
              {
                "phrase": "Call 911 (or your local emergency number)",
                "meaning": "Instruction to contact emergency services"
              },
              {
              ...
              {
                "phrase": "I need a firetruck!",
                "meaning": "Requesting immediate fire department assistance"
              }
            ]
          },
          {
            "exampleName": "Describing the Situation",
            "exampleList": [
              {
          ...
          {
            "exampleName": "Requesting Specific Assistance",
            "exampleList": [
              {
                "phrase": "Please send help immediately!",
                "meaning": "Urgent request for assistance"
              },
              {
              ...
              {
                "phrase": "My location is [Location]",
                "meaning": "Providing location information"
              }
            ]
          }
        ...
        "keyVocabulary": [
          {"phrase": "Help!", "usage": "General call for help"},
          {"phrase": "911", "usage": "Emergency services number (US)"},
          {"phrase": "There's a fire!", "usage": "Reporting a fire"}
        ],
        "media": [
          "https://example.com/audio-emergency-en.mp3",
          "https://example.com/image-emergency-en.png"
        ]
      }
    ]
  }]
